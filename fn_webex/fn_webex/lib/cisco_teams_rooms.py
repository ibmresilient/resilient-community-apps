...
class WebexAPI:
    def __init__(self, requiredParameters, api):
        self.api = api
    ...
    def generate_member_list(self):
        ...
        if self.requiredParameters["addAllMembers"]:
            ...
            self.LOG.info("Warning: No participants were added. ADD_ALL_INCIDENT_MEMBERS was set to NO and no list of participants were provided in the ADDITIONAL_ATTENDEE field.")
        ...
        self.LOG.info("Webex: Members to be added {}".format(self.emailIDs))
