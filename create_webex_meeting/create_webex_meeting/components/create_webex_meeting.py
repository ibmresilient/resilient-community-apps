...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'create_webex_meeting"""
    ...
    @function("create_webex_meeting")
    def _create_webex_meeting_function(self, event, *args, **kwargs):
