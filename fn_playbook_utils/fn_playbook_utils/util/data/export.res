  ...
  "actions": [
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "WF: Get workflow content",
      "id": 118,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflow content",
    ...
    },
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "WF: Get workflow frequency",
      "id": 119,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflow frequency",
    ...
    },
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "WF: Get workflows by artifact value",
      "id": 111,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflows by artifact value",
    ...
    },
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "WF: Get workflows by attachment name",
      "id": 113,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflows by attachment name",
    ...
    },
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "WF: Get workflows by task name",
      "id": 112,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflows by task name",
      "object_type": "task",
      "tags": [
        {
          "tag_handle": "fn_playbook_utils",
    ...
    },
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "WF: Get workflow usage",
      "id": 110,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflow usage",
      "object_type": "incident",
      "tags": [
        {
          "tag_handle": "fn_playbook_utils",
    ...
    },
    {
      ...
      "enabled": false,
      "export_key": "WF: Get workflow usage at incident close",
      "id": 116,
      "logic_type": "all",
      "message_destinations": [],
      "name": "WF: Get workflow usage at incident close",
      "object_type": "incident",
      "tags": [
        {
          "tag_handle": "fn_playbook_utils",
  ...
  "fields": [
    {
      ...
      "deprecated": false,
      "export_key": "__function/wf_workflow_id",
    ...
    },
    {
      ...
      "default_chosen_by_server": false,
      "deprecated": false,
      "export_key": "__function/wf_min_incident_id",
      "hide_notification": false,
      "id": 623,
      "input_type": "number",
      "internal": false,
      "is_tracked": false,
      "name": "wf_min_incident_id",
      "operation_perms": {},
      "operations": [],
      "placeholder": "",
      "prefix": null,
    ...
    },
    {
      ...
      "default_chosen_by_server": false,
      "deprecated": false,
      "export_key": "__function/wf_max_incident_id",
      "hide_notification": false,
      "id": 624,
      "input_type": "number",
      "internal": false,
      "is_tracked": false,
      "name": "wf_max_incident_id",
      "operation_perms": {},
      "operations": [],
      "placeholder": "",
      "prefix": null,
    ...
    },
    {
      ...
      "default_chosen_by_server": false,
      "deprecated": false,
      "export_key": "actioninvocation/wf_min_incident_id",
      "hide_notification": false,
      "id": 638,
      "input_type": "number",
      "internal": false,
    ...
    },
    {
      ...
      "default_chosen_by_server": false,
      "deprecated": false,
      "export_key": "actioninvocation/wf_max_incident_id",
      "hide_notification": false,
      "id": 639,
      "input_type": "number",
      "internal": false,
  ...
  "functions": [
    {
      ...
      "display_name": "WF: Get Workflow content",
      ...
      "last_modified_time": 1627414053038,
      "name": "wf_get_workflow_content",
      "tags": [
        {
          "tag_handle": "fn_playbook_utils",
          "value": null
    ...
    },
    {
      ...
      "destination_handle": "fn_playbook_utils",
      "display_name": "WF: Get workflow data",
      ...
      "last_modified_time": 1627414024385,
      "name": "wf_get_workflow_data",
      "tags": [
        {
          "tag_handle": "fn_playbook_utils",
          "value": null
      ...
      "workflows": [
        ...
        },
        {
          "actions": [],
          "description": null,
          "name": "WF: Get workflow usage statistics",
          "object_type": "incident",
          "programmatic_name": "wf_get_workflow_usage_statistics",
          "tags": [],
          "uuid": null,
          "workflow_id": 103
        },
        ...
        },
        {
          "actions": [],
          "description": null,
          "name": "WF: Get workflows by attachment filename",
          "object_type": "attachment",
  ...
  "workflows": [
    {
      ...
      "last_modified_time": 1627386487417,
      "name": "WF: Get workflow content",
      "object_type": "workflow_usage",
      "programmatic_name": "wf_get_workflow_content",
      "tags": [
    ...
    },
    {
      ...
      "last_modified_by": "a@example.com",
      "last_modified_time": 1627413619711,
      "name": "WF: Get workflows by task name",
      "object_type": "task",
      "programmatic_name": "wf_get_workflows_by_task_name",
      "tags": [
    ...
    },
    {
      ...
      "export_key": "wf_get_workflow_data",
      "last_modified_by": "a@example.com",
      "last_modified_time": 1627386486635,
      "name": "WF: Get workflow usage",
      "object_type": "incident",
      "programmatic_name": "wf_get_workflow_data",
      "tags": [
    ...
    },
    {
      ...
      "last_modified_by": "a@example.com",
      "last_modified_time": 1627386486401,
      "name": "WF: Get workflow usage at incident close",
      "object_type": "incident",
      "programmatic_name": "wf_get_workflow_usage_at_incident_close",
      "tags": [
    ...
    },
    {
      ...
      "last_modified_by": "a@example.com",
      "last_modified_time": 1627390519017,
      "name": "WF: Get workflow frequency",
      "object_type": "incident",
      "programmatic_name": "wf_get_workflow_frequency",
      "tags": [
    ...
    },
    {
      ...
      "last_modified_by": "a@example.com",
      "last_modified_time": 1627413645330,
      "name": "WF: Get workflows by artifact value",
      "object_type": "artifact",
      "programmatic_name": "wf_get_workflows_by_artifact_value",
      "tags": [
    ...
    },
    {
      ...
      "last_modified_by": "a@example.com",
      "last_modified_time": 1627413632059,
      "name": "WF: Get workflows by attachment filename",
      "object_type": "attachment",
      "programmatic_name": "wf_get_workflows_by_attachment_filename",
      "tags": [
