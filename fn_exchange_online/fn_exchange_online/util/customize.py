...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [u"exchange_online_create_meeting", u"exchange_online_query_emails", u"exchange_online_write_message_as_attachment", u"exchange_online_move_message_to_folder", u"exchange_online_delete_email", u"exchange_online_send_message", u"exchange_online_get_message", u"exchange_online_get_email_user_profile", u"exchange_online_delete_messages_from_query_results"],
        "workflows": [u"example_exchange_online_get_message", u"example_exchange_online_delete_email", u"example_exchange_online_query_emails", u"example_exchange_online_query_messages_of_a_group", u"example_exchange_online_get_user_profile", u"example_exchange_online_delete_messages_from_query_results", u"example_exchange_online_move_message_to_folder", u"example_exchange_online_create_meeting", u"example_exchange_online_write_message_as_attachment", u"example_exchange_online_send_message"],
        "actions": [u"Example: Exchange Online Write Message JSON as Note", u"Example: Exchange Online Create Meeting", u"Example: Exchange Online Get User Profile", u"Example: Exchange Online Send Message", u"Example: Exchange Online Query Messages on Artifact", u"Example: Exchange Online Create Artifacts", u"Example: Exchange Online Delete Message", u"Example: Exchange Online Delete Messages from Query Results", u"Example: Exchange Online Write Message EML as Attachment", u"Example: Exchange Online Move Message to Folder", u"Example: Exchange Online Query Messages"],
        "incident_fields": [],
