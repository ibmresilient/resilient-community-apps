...
class TestDataFeederSyncIncidents:
    ...
    @pytest.mark.parametrize("df_min_incident_id, df_max_incident_id, expected_results", [
        (123, 123, {"value": "xyz"}),
        (123, 123, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, df_min_incident_id, df_max_incident_id, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "df_min_incident_id": df_min_incident_id,
            "df_max_incident_id": df_max_incident_id
        }
        results = call_data_feeder_sync_incidents_function(circuits_app, function_params)
