...
| Version | Date | Notes |
| ------- | ---- | ----- |
| 2.1.6 | 08/2026 | Bug fix for incident description rich-text content formatting lost when sending HTML email. Updated example playbooks to render description HTML directly instead of stripping tags |
