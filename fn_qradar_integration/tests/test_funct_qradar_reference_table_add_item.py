...
FUNCTION_NAME = "qradar_reference_table_add_item"
...
def call_qradar_reference_table_add_item_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("qradar_reference_table_add_item", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("qradar_reference_table_add_item_result", parent=evt, timeout=timeout)
        assert event
...
class TestQradarReferenceTableAddItem:
    """ Tests for the qradar_reference_table_add_item function"""
    ...
    expected_results_2 = MOCK_ADD_RESPONSE
