...
class FunctionComponent(ResilientComponent):
    ...
    def _qradar_add_reference_set_item_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            yield StatusMessage(f"Starting 'qradar_add_reference_set_item' that was running in workflow '{wf_instance_id}'")
            ...
            yield StatusMessage(f"Finished 'qradar_add_reference_set_item' that was running in workflow '{wf_instance_id}'")
