...
class FunctionComponent(ResilientComponent):
    ...
    def _qradar_reference_table_get_table_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            yield StatusMessage(f"Starting 'qradar_reference_table_get_table' running in workflow '{wf_instance_id}'")
            ...
            yield StatusMessage(f"Finished 'qradar_reference_table_get_table' that was running in workflow '{wf_instance_id}'")
