...
def codegen_reload_data():
    ...
    return {
        ...
        "incident_types": [],
        "datatables": [
            u"qradar_offense_event",
            u"qradar_reference_set",
            u"qradar_reference_table",
            u"qradar_reference_table_queried_rows"
        ],
        "automatic_tasks": [],
        "scripts": [],
        "playbooks": [
            u"find_in_qradar_reference_set_pb",
            u"get_all_qradar_reference_sets",
            u"qradar_add_item_to_this_reference_table_example",
            u"qradar_add_to_reference_set",
            u"qradar_add_to_reference_table",
            u"qradar_delete_this_reference_table_item_example",
