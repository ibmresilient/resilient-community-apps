...
class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'funct_extrahop_rx_search_detections'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Search for detections information from Extrahop Reveal(x).
        ...
        for i in ["extrahop_search_filter", "extrahop_limit",
        ...
        response = rx_cli.search_detections(**params)
        # Response is a list, returned result needs to be a dict
        results = {"search_result": response.json()}
