...
def codegen_reload_data():
    ...
    return {
        ...
        "workflows": [u"wf_extrahop_rx_assign_tag", u"wf_extrahop_rx_create_tag", u"wf_extrahop_rx_get_activitymaps", u"wf_extrahop_rx_get_devices", u"wf_extrahop_rx_get_tags", u"wf_extrahop_rx_get_watchlist", u"wf_extrahop_rx_search_detections", u"wf_extrahop_rx_search_devices", u"wf_extrahop_rx_update_detection", u"wf_extrahop_rx_update_incident", u"wf_extrahop_rx_update_watchlist"],
        "actions": [u"Example: Extrahop Reveal(x) assign tag", u"Example: Extrahop Reveal(x) create tag", u"Example: Extrahop Reveal(x) get activitymaps", u"Example: Extrahop Reveal(x) get devices", u"Example: Extrahop Reveal(x) get tags", u"Example: Extrahop Reveal(x) get watchlist", u"Example: Extrahop Reveal(x) search detections", u"Example: Extrahop Reveal(x) search devices", u"Example: Extrahop Reveal(x) update detection", u"Example: Extrahop Reveal(x) update incident", u"Example: Extrahop Reveal(x) update watchlist"],
        "incident_fields": [u"extrahop_assignee", u"extrahop_detection_id", u"extrahop_detection_link", u"extrahop_end_time", u"extrahop_risk_score", u"extrahop_status", u"extrahop_ticket_id", u"extrahop_update_time"],
