...
FUNCTION_NAME = "funct_extrahop_rx_update_detection"
...
def call_funct_extrahop_rx_update_detection_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("funct_extrahop_rx_update_detection", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("funct_extrahop_rx_update_detection_result", parent=evt, timeout=timeout)
        assert event
...
class TestFunctExtrahopRxUpdateDetection:
    """ Tests for the funct_extrahop_rx_update_detection function"""
    ...
    def test_success(self, mock_cli, circuits_app, mock_inputs, expected_results):
        ...
        results = call_funct_extrahop_rx_update_detection_function(circuits_app, mock_inputs)
