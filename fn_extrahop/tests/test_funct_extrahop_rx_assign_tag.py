...
FUNCTION_NAME = "funct_extrahop_rx_assign_tag"
...
def call_funct_extrahop_rx_assign_tag_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("funct_extrahop_rx_assign_tag", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("funct_extrahop_rx_assign_tag_result", parent=evt, timeout=timeout)
        assert event
...
class TestFunctExtrahopRxAssignTag:
    """ Tests for the funct_extrahop_rx_assign_tag function"""
    ...
    def test_success(self, mock_cli, circuits_app, mock_inputs, expected_results):
        ...
        results = call_funct_extrahop_rx_assign_tag_function(circuits_app, mock_inputs)
