...
# Playbook - ExtraHop Reveal(x): Update Case (PB)
...
## Local script - ExtraHop: Write get detections to data table 

### Description
Write the get detections data to the ExtraHop Detections data table and create artifacts.
...
---
## Local script - ExtraHop: Write Get Devices data to Devices data table

### Description
Write the results from get devices function to the ExtraHop Devices data table.
