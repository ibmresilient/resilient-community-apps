...
setup(
    name='rc_data_feed_plugin_filefeed',
    version='1.0.1',
    license='MIT',
    ...
    entry_points={
        ...
        "resilient.circuits.apphost.configsection": ["gen_config = data_feeder_plugins.filefeed.util.config:apphost_config_section_data"],
        "resilient.circuits.customize": ["customize = data_feeder_plugins.filefeed.util.customize:customization_data"]
    },
