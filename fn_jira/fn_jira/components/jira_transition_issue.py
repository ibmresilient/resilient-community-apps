...
from .jira_common import transition_issue, create_comment
...
class FunctionComponent(ResilientComponent):
    ...
    def _build_transitionIssue_appDict(self, kwargs):
        ...
        if not kwargs.get('jira_transition_id', None):
            raise AttributeError("Missing required field: jira_transition_id")
        ...
        if kwargs.get('jira_comment', None):
            appDict['comment'] = kwargs['jira_comment']
