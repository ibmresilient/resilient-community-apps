...
PACKAGE_NAME = "fn_bigfix_integration"
...
class TestFnBigfixArtifact:
    ...
    @pytest.mark.parametrize("bigfix_artifact_id, bigfix_artifact_value, bigfix_artifact_type, bigfix_incident_id, bigfix_incident_plan_status, bigfix_artifact_properties_name, bigfix_artifact_properties_value, expected_results", [
        (123, "text", "text", 123, "text", "text", "text", {"value": "xyz"}),
        (123, "text", "text", 123, "text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, bigfix_artifact_id, bigfix_artifact_value, bigfix_artifact_type, bigfix_incident_id, bigfix_incident_plan_status, bigfix_artifact_properties_name, bigfix_artifact_properties_value, expected_results):
