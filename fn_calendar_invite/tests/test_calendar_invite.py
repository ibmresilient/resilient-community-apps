...
class TestCalendarInvite:
    ...
    @pytest.mark.parametrize("calendar_invite_datetime, calendar_invite_subject, calendar_invite_description, calendar_incident_id, expected_results", [
        (1518367008000, "text", "text", "text", {"value": "xyz"}),
        (1518367008000, "text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, calendar_invite_datetime, calendar_invite_subject, calendar_invite_description, calendar_incident_id, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "calendar_invite_datetime": calendar_invite_datetime,
            "calendar_invite_subject": calendar_invite_subject,
