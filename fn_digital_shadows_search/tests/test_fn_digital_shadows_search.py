...
class TestFnDigitalShadowsSearch:
    ...
    @pytest.mark.parametrize("ds_search_value, expected_results", [
        ("text", {"value": "xyz"}),
        ("text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, ds_search_value, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "ds_search_value": ds_search_value
        }
        results = call_fn_digital_shadows_search_function(circuits_app, function_params)
