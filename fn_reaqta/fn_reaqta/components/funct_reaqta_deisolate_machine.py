...
FN_NAME = "reaqta_deisolate_machine"


class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'reaqta_deisolate_machine'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Deisolate a existing ReaQta controlled machine based on it's endpoint ID
        Inputs:
        ...
        if not hive_settings:
            ...
            results, err_msg = app_common.deisolate_machine(fn_inputs.reaqta_endpoint_id)
