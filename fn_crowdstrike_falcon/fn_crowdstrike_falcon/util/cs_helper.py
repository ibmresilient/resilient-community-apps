...
class CrowdStrikeHelper(object):
    ...
    def load_class_variables(cls, app_configs):
        ...
        cls.oauth2_cid = cls.__get_config_option(app_configs, "cs_falcon_oauth2_cid", placeholder="<YOUR CROWDSTRIKE CLIENT ID>")
        cls.oauth2_key = cls.__get_config_option(app_configs, "cs_falcon_oauth2_key", placeholder="<YOUR CROWDSTRIKE OAUTH2 KEY>")
        cls.bauth_base_url = cls.__get_config_option(app_configs, "cs_falcon_bauth_base_url")
        cls.bauth_api_uuid = cls.__get_config_option(app_configs, "cs_falcon_bauth_api_uuid", placeholder="<YOUR CROWDSTRIKE UUID>")
        cls.bauth_api_key = cls.__get_config_option(app_configs, "cs_falcon_bauth_api_key", placeholder="<YOUR CROWDSTRIKE API KEY>")
