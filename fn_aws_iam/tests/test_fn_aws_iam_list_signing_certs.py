...
FUNCTION_NAME = "fn_aws_iam_list_signing_certs"
...
def call_fn_aws_iam_list_signing_certs_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("fn_aws_iam_list_signing_certs", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("fn_aws_iam_list_signing_certs_result", parent=evt, timeout=timeout)
        assert event
...
class TestFnAwsIamListSigningCerts:
    """ Tests for the fn_aws_iam_list_signing_certs function"""
    ...
    def test_success(self, mock_get, circuits_app, aws_iam_user_name, expected_results):
        ...
        results = call_fn_aws_iam_list_signing_certs_function(circuits_app, function_params)
