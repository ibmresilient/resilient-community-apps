...
FUNCTION_NAME = "fn_aws_iam_delete_ssh_keys"
...
def call_fn_aws_iam_delete_ssh_keys_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("fn_aws_iam_delete_ssh_keys", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("fn_aws_iam_delete_ssh_keys_result", parent=evt, timeout=timeout)
        assert event
...
class TestFnAwsIamDeleteSshKeys:
    """ Tests for the fn_aws_iam_delete_ssh_keys function"""
    ...
    def test_success(self, mock_post, circuits_app, aws_iam_user_name, aws_iam_ssh_key_ids, expected_results):
        ...
        function_params = {
            ...
            "aws_iam_ssh_key_ids": aws_iam_ssh_key_ids
        }

        results = call_fn_aws_iam_delete_ssh_keys_function(circuits_app, function_params)
