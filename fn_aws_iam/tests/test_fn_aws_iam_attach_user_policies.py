...
class TestFnAwsIamAttachUserPolicies:
    ...
    @patch('fn_aws_iam.components.fn_aws_iam_attach_user_policies.AwsIamClient', side_effect=mocked_aws_iam_client)
    @pytest.mark.parametrize("aws_iam_user_name, aws_iam_arns, aws_iam_policy_names, expected_results", [
        ("iam_test_User", None, "deny_all", [{"PolicyName": "deny_all", "Status": "OK"}]),
        ("iam_test_User", None, "AWSDenyAll", [{"PolicyName": "AWSDenyAll", "Status": "OK"}]),
        ("iam_test_User", "arn:aws:iam::123456789012:policy/deny_all", None, [{"PolicyArn": "arn:aws:iam::123456789012:policy/deny_all", "Status": "OK"}]),
        ("iam_test_User", "arn:aws:iam::aws:policy/AWSDenyAll", None, [{"PolicyArn": "arn:aws:iam::aws:policy/AWSDenyAll", "Status": "OK"}]),
        ("iam_test_User", "not_exists", None, [{"PolicyArn": "not_exists", "Status": "NoSuchEntity"}]),
    ])
    def test_success(self, mock_post, circuits_app, aws_iam_user_name, aws_iam_arns, aws_iam_policy_names,
                     expected_results):
