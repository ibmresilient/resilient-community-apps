    ...
    def _fn_aws_iam_delete_mfa_devices_function(self, event, *args, **kwargs):
       ...
       param aws_iam_mfa_serial_numbers: A comma separated list of IAM MFA serial numbers or arns.
        ...
        try:
            ...
            # 'param aws_iam_mfa_serial_numbers'. Add each in turn to the 'params' dict then attempt to delete each
            # virtual mfa. Include the status of each attempt in the returned result.
