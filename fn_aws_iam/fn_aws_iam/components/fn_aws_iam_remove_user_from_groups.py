...
class FunctionComponent(ResilientComponent):
    ...
    def _fn_aws_iam_remove_user_from_groups_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            # Get user groups
            user_groups = iam.result_paginator("list_groups_for_user", UserName=aws_iam_user_name)
            rtn = []
            ...
            # Test if policy_names are attached for user name and get arn.
                ...
                if not group:
                    ...
                    rtn.append({"GroupName": group_name, "Status": iam.remove_user_from_group(**params)})
