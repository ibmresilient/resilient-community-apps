...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'fn_aws_iam_list_signing_certs'"""
    ...
    @function("fn_aws_iam_list_signing_certs")
    def _fn_aws_iam_list_signing_certs_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            rtn = iam_cli.get("list_signing_certificates", paginate=True, **params)
