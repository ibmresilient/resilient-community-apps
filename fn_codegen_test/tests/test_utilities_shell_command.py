...
class TestUtilitiesShellCommand:
    ...
    @pytest.mark.parametrize("shell_command, shell_remote, shell_param1, shell_param2, shell_param3, expected_results", [
        ("text", True, "text", "text", "text", {"value": "xyz"}),
        ("text", True, "text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, shell_command, shell_remote, shell_param1, shell_param2, shell_param3, expected_results):
