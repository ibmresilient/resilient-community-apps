...
class TestUtilitiesExcelQuery:
    ...
    @pytest.mark.parametrize("task_id, excel_ranges, incident_id, excel_defined_names, attachment_id, expected_results", [
        (123, "text", 123, "text", 123, {"value": "xyz"}),
        (123, "text", 123, "text", 123, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, task_id, excel_ranges, incident_id, excel_defined_names, attachment_id, expected_results):
