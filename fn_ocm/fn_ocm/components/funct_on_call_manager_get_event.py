...
FN_NAME = "on_call_manager_get_event"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'on_call_manager_get_event'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Get the details of an event
        Inputs:
            -   fn_inputs.ocm_eventid
            -   fn_inputs.ocm_deduplicationkey
        """
        yield self.status_message(f"Starting App Function: '{FN_NAME}'")
       # Validate required fields
        validate_fields(["ocm_eventid", "ocm_deduplicationkey"], fn_inputs)
        try:
            ...
            # Make API call to get the details of an event.
            results = client.get_event(fn_inputs.ocm_eventid, fn_inputs.ocm_deduplicationkey)
