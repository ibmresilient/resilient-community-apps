...
def call_utilities_get_contact_info_function(circuits, function_params, timeout=5):
...
class TestUtilitiesGetContactInfo:
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_get_contact_info_function(circuits_app, mock_inputs)
