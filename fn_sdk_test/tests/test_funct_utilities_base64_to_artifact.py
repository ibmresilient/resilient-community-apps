...
def call_utilities_base64_to_artifact_function(circuits, function_params, timeout=5):
...
class TestUtilitiesBase64ToArtifact:
    ...
    mock_inputs_1 = {
        "artifact_file_type": "Email Attachment",
        "base64content": "sample text",
        "incident_id": 123,
        "file_name": "sample text",
        "description": {"type": "text", "content": "sample line one\nsample line two"},
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_base64_to_artifact_function(circuits_app, mock_inputs)
