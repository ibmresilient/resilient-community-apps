...
def call_utilities_string_to_attachment_function(circuits, function_params, timeout=5):
...
class TestUtilitiesStringToAttachment:
    ...
    mock_inputs_1 = {
        "string_to_convert_to_attachment": "sample text",
        "incident_id": 123,
        "task_id": 123,
        "attachment_name": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_string_to_attachment_function(circuits_app, mock_inputs)
