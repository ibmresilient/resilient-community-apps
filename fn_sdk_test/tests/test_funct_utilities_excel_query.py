...
def call_utilities_excel_query_function(circuits, function_params, timeout=5):
...
class TestUtilitiesExcelQuery:
    ...
    mock_inputs_1 = {
        "incident_id": 123,
        "task_id": 123,
        "excel_ranges": "sample text",
        "excel_defined_names": "sample text",
        "attachment_id": 123
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_excel_query_function(circuits_app, mock_inputs)
