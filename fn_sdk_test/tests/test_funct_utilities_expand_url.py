...
def call_utilities_expand_url_function(circuits, function_params, timeout=5):
...
class TestUtilitiesExpandUrl:
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_expand_url_function(circuits_app, mock_inputs)
