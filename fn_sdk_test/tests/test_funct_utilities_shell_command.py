...
def call_utilities_shell_command_function(circuits, function_params, timeout=5):
...
class TestUtilitiesShellCommand:
    ...
    mock_inputs_1 = {
        "shell_command": "sample text",
        "shell_param1": "sample text",
        "shell_remote": True,
        "shell_param2": "sample text",
        "shell_param3": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_shell_command_function(circuits_app, mock_inputs)
