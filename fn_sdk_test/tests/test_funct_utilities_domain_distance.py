...
def call_utilities_domain_distance_function(circuits, function_params, timeout=5):
...
class TestUtilitiesDomainDistance:
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_domain_distance_function(circuits_app, mock_inputs)
