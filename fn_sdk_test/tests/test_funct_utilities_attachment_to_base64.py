...
def call_utilities_attachment_to_base64_function(circuits, function_params, timeout=5):
...
class TestUtilitiesAttachmentToBase64:
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_attachment_to_base64_function(circuits_app, mock_inputs)
