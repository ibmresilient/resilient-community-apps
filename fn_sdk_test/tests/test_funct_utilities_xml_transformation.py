...
def call_utilities_xml_transformation_function(circuits, function_params, timeout=5):
...
class TestUtilitiesXmlTransformation:
    ...
    mock_inputs_1 = {
        "xml_stylesheet": "sample text",
        "xml_source": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_xml_transformation_function(circuits_app, mock_inputs)
