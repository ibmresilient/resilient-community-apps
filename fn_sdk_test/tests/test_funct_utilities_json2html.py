...
def call_utilities_json2html_function(circuits, function_params, timeout=5):
...
class TestUtilitiesJson2Html:
    ...
    mock_inputs_1 = {
        "json2html_data": "sample text",
        "json2html_keys": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_utilities_json2html_function(circuits_app, mock_inputs)
