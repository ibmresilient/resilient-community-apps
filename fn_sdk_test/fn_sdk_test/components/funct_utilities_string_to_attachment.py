...
class FunctionComponent(ResilientComponent):
    ...
    def _utilities_string_to_attachment_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            yield StatusMessage("Starting 'utilities_string_to_attachment' running in workflow '{0}'".format(wf_instance_id))
            ...
            yield StatusMessage("Finished 'utilities_string_to_attachment' that was running in workflow '{0}'".format(wf_instance_id))
