# docker build -t ibmresilient/fn_microsoft_security_graph:1.2.0 -t ibmresilient/fn_microsoft_security_graph:latest .

# Base image using Red Hat's universal base image (rhel 8) for python
FROM registry.access.redhat.com/ubi8/python-39:latest

ARG APPLICATION=fn_microsoft_security_graph
