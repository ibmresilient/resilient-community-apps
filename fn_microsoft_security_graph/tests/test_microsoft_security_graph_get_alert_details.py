...
class TestMicrosoftSecurityGraphGetAlertDetails:
    ...
    @pytest.mark.parametrize("microsoft_security_graph_alert_id, expected_results", [
        ("text", {"value": "xyz"}),
        ("text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, microsoft_security_graph_alert_id, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "microsoft_security_graph_alert_id": microsoft_security_graph_alert_id
        }
        results = call_microsoft_security_graph_get_alert_details_function(circuits_app, function_params)
