...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'set_event_classifications"""
    ...
    @function("set_event_classifications")
    def _set_event_classifications_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            result = risk_fabric.set_event_classifications(self.options, params)
