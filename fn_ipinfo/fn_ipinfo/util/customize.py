...
"""Generate the SOAR customizations required for fn_ipinfo"""
...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [
            u"fn_ipinfo_query_ip_address"
        ],
        "workflows": [
            u"example_query_ip_artifact_with_ipinfo"
        ],
        "actions": [
            u"Query Artifact with IP Info"
        ],
        "incident_fields": [],
