...
def codegen_reload_data():
    ...
    return {
        ...
        "workflows": [
            ...
            u"mcafee_epo_get_system_information",
            u"mcafee_epo_list_issues",
            u"mcafee_epo_list_tags",
        ...
        "actions": [
            u"McAfee ePO Add Permission Set to User",
            u"McAfee ePO Add System",
            u"McAfee ePO Add User",
            u"McAfee ePO Apply a Tag",
            u"McAfee ePO Apply Tags",
            u"McAfee ePO Assign Policy to Group from Group",
            u"McAfee ePO Assign Policy to Group from Policy",
            u"McAfee ePO Assign Policy to System from System",
            u"McAfee ePO Assign Policy to Systems from Policy",
            u"McAfee ePO Create Issue",
            u"McAfee ePO Delete Issue",
            u"McAfee ePO Delete System",
            u"McAfee ePO Find All Client Tasks",
            u"McAfee ePO Find All Groups",
            u"McAfee ePO Find Policies",
            u"McAfee ePO Get All Permission Sets",
            u"McAfee ePO Get All Systems",
            u"McAfee ePO Get All Users",
            u"McAfee ePO Get System Info",
            u"McAfee ePO Get System Info from Property",
            u"McAfee ePO Get System Information",
            u"McAfee ePO List Issues",
            u"McAfee ePO List Tags",
            u"McAfee ePO Remove Permission Set from User",
            u"McAfee ePO Remove Tags",
            u"McAfee ePO Remove User",
            u"McAfee ePO Run Client Task",
            u"McAfee ePO Run Client Task on System",
            u"McAfee ePO Update Issue",
            u"McAfee ePO Update User",
            u"McAfee ePO Wake up Agent"
        ],
        "incident_fields": [],
