{
  ...
  "actions": [
    ...
    },
    {
      ...
      "conditions": [],
      "enabled": true,
      "export_key": "McAfee Run Client Task",
      "id": 114,
      "logic_type": "all",
      "message_destinations": [],
      "name": "McAfee Run Client Task",
  ...
  "types": [
    {
      ...
      "fields": {
        "object_id": {
          ...
          "default_chosen_by_server": false,
          "deprecated": false,
          "export_key": "mcafee_epo_client_tasks/object_id",
          "hide_notification": false,
          "id": 1196,
          "input_type": "number",
          "internal": false,
