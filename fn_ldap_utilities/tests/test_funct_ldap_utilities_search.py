...
def call_ldap_utilities_search_function(circuits, function_params, timeout=5):
...
class TestLdapUtilitiesSearch:
    ...
    mock_inputs_1 = {
        "ldap_search_filter": {"type": "text", "content": "sample line one\nsample line two"},
        "ldap_search_base": "sample text",
        "ldap_search_attributes": "sample text",
        "ldap_search_param": "sample text",
        "ldap_domain_name": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_ldap_utilities_search_function(circuits_app, mock_inputs)
