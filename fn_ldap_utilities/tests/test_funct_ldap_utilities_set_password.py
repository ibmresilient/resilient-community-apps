...
def call_ldap_utilities_set_password_function(circuits, function_params, timeout=5):
...
class TestLdapUtilitiesSetPassword:
    ...
    mock_inputs_1 = {
        "ldap_dn": "sample text",
        "ldap_new_password": "sample text",
        "ldap_domain_name": "sample text",
        "ldap_return_new_password": True,
        "ldap_new_auto_password_len": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_ldap_utilities_set_password_function(circuits_app, mock_inputs)
