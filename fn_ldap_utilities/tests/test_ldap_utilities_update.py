...
class TestLdapUtilitiesUpdate:
    ...
    @pytest.mark.parametrize("ldap_dn, ldap_attribute_name, ldap_attribute_value, expected_results", [
        ("text", "text", "text", {"value": "xyz"}),
        ("text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, ldap_dn, ldap_attribute_name, ldap_attribute_value, expected_results):
