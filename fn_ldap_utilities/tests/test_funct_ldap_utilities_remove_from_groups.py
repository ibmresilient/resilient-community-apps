...
def call_ldap_utilities_remove_from_groups_function(circuits, function_params, timeout=5):
...
class TestLdapUtilitiesRemoveFromGroups:
    ...
    mock_inputs_1 = {
        "ldap_multiple_group_dn": "sample text",
        "ldap_multiple_user_dn": "sample text",
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_ldap_utilities_remove_from_groups_function(circuits_app, mock_inputs)
