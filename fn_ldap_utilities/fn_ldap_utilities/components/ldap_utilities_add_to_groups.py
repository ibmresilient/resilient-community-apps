...
class FunctionComponent(ResilientComponent):
    ...
    def _ldap_utilities_add_to_groups_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            yield StatusMessage("Starting 'ldap_utilities_add_to_groups' running in workflow '{0}'".format(wf_instance_id))
            ...
            try:
              ...
              res = ad_add_members_to_groups(c, ldap_multiple_user_dn, ldap_multiple_group_dn, True)
              # Test: res = 'ad_add_members_to_groups(c, ' + str(ldap_multiple_user_dn) + ', ' + str(ldap_multiple_group_dn) + ', True)'
            ...
            yield StatusMessage("Finished 'ldap_utilities_add_to_groups' that was running in workflow '{0}'".format(wf_instance_id))
