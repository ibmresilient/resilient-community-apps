...
FN_NAME = "pagerduty_list_services"
...
class FunctionComponent(AppFunctionComponent):
    ...
    def _app_function(self, fn_inputs):
        """Function: List PagerDuty services"""
        try:
            # validate the function parameters:
            yield self.status_message("Starting List Services...")
            resp = PDClient(self.options).list_services()
            yield self.status_message("PagerDuty Services Listed")
