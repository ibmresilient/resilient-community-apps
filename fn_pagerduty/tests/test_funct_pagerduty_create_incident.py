...
def call_pagerduty_create_incident_function(circuits, function_params, timeout=5):
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("pagerduty_create_incident_result", parent=evt, timeout=timeout)
        assert event
...
class TestPagerdutyCreateIncident:
    ...
    mock_inputs_1 = {
        "pd_title": "sample text",
        "pd_priority": "sample text",
        "pd_escalation_policy": "sample text",
        "incidentID": 123,
        "pd_service": "sample text",
        "pd_description": "sample text",
        "pd_incident_key": "sample text"
    }
