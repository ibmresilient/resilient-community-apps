...
def call_fn_get_step_function_execution_function(circuits, function_params, timeout=10):
...
class TestFnGetStepFunctionExecution:
    ...
    def test_success(self, circuits_app, execution_id, expected_results):
        ...
        results = call_fn_get_step_function_execution_function(circuits_app, function_params)
