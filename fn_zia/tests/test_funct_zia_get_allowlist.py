...
PACKAGE_NAME = "fn_zia"
FUNCTION_NAME = "funct_zia_get_allowlist"
...
def call_funct_zia_get_allowlist_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("funct_zia_get_allowlist", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("funct_zia_get_allowlist_result", parent=evt, timeout=timeout)
        assert event
...
class TestFunctZiaGetAllowlist:
    """ Tests for the funct_zia_get_allowlist function"""
    ...
    def test_success(self, mock_cli, circuits_app, mock_inputs, expected_results):
        ...
        results = call_funct_zia_get_allowlist_function(circuits_app, mock_inputs)
