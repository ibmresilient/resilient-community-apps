...
PACKAGE_NAME = "fn_zia"
FUNCTION_NAME = "funct_zia_url_lookup"
...
def call_funct_zia_url_lookup_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("funct_zia_url_lookup", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("funct_zia_url_lookup_result", parent=evt, timeout=timeout)
        assert event
...
class TestFunctZiaUrlLookup:
    """ Tests for the funct_zia_url_lookup function"""
    ...
    @patch("fn_zia.components.funct_zia_url_lookup.ZiaClient", side_effect=mocked_zia_client)
    ...
    def test_success(self, mock_cli, circuits_app, mock_inputs, expected_results):
        ...
        results = call_funct_zia_url_lookup_function(circuits_app, mock_inputs)
