...
def call_funct_zia_add_to_blocklist_function(circuits, function_params, timeout=5):
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("funct_zia_add_to_blocklist_result", parent=evt, timeout=timeout)
        assert event
...
class TestFunctZiaAddToBlocklist:
    """ Tests for the funct_zia_add_to_blocklist function"""
