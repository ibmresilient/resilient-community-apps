...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'funct_zia_add_to_url_category''"""
    ...
    def _funct_zia_add_to_url_category_function(self, event, *args, **kwargs):
        """Function: Add URLs or IP addresses to a URL Category. See following for URL guidelines https://help.zscaler.com/zia/url-format-guidelines"""
        try:
