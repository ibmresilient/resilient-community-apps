...
# Playbook - Playbooks: Exchange Delete Email
...
| ----------------- | -------- | ------------ | ------- | ----------- |
| Delete Permanently | `exchange_hard_delete` | boolean | Yes deletes the emails permanently. No moves the mails to the Trash folder | Optional |
