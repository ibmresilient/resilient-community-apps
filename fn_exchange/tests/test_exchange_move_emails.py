...
class TestExchangeMoveEmails:
    ...
    @patch('fn_exchange.components.exchange_move_emails.exchange_utils', side_effect=mocked_exchange_utils)
    @pytest.mark.parametrize("exchange_email, exchange_folder_path, exchange_destination_folder_path, exchange_sender, exchange_start_date, exchange_end_date, expected_results", [
        ("user@exch.com", "Top of Information Store/TESTFOLDER_1", "Top of Information Store/TESTFOLDER_2", "text", 1518480000000, 1518480000000,
    ...
    def test_success(self, mock_utils, circuits_app, exchange_email, exchange_folder_path, exchange_destination_folder_path, exchange_sender, exchange_start_date, exchange_end_date, expected_results):
