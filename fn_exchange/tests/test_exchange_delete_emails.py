...
FUNCTION_NAME = "exchange_delete_emails"
...
def call_exchange_delete_emails_function(circuits, function_params, timeout=10):
    # Fire a message to the function
    evt = SubmitTestFunction("exchange_delete_emails", function_params)
    circuits.manager.fire(evt)
    event = circuits.watcher.wait("exchange_delete_emails_result", parent=evt, timeout=timeout)
    assert event
...
class TestExchangeDeleteEmails:
    """ Tests for the exchange_delete_emails function"""
    ...
    @pytest.mark.parametrize("exchange_email, exchange_hard_delete, exchange_folder_path, exchange_sender, exchange_start_date, exchange_end_date, expected_results", [
        ("user@exch.com", False, "Top of Information Store/TESTFOLDER_1", "jdoe@exch.com", 1518480000000,
         1518480000000, {'email_ids': ['<ed6f175b4ef84ceaa921ba8bfdd37739@exch.exch.com>'], 'emails': {
        ...
        ("user@exch.com", True, "Top of Information Store/TESTFOLDER_1", "jdoe@exch.com", 1518480000000,
         1518480000000, {'email_ids': ['<ed6f175b4ef84ceaa921ba8bfdd37739@exch.exch.com>'], 'emails': {
            '<ed6f175b4ef84ceaa921ba8bfdd37739@exch.exch.com>': {
                'body': '<html>\r\n<head>\r\n<meta http-equiv="Content-Type" content="text\\/html; charset=utf-8">\r\n<\\/head>\r\n<body>\r\nExample Body\r\n<\\/body>\r\n<\\/html>\r\n',
                'attachments': {}, 'attachment_ids': [], 'sender_name': 'John Doe',
    ...
    def test_success(self, mock_utils, circuits_app, exchange_email, exchange_hard_delete, exchange_folder_path, exchange_sender, exchange_start_date, exchange_end_date, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "exchange_email": exchange_email,
            "exchange_hard_delete": exchange_hard_delete,
        ...
        results = call_exchange_delete_emails_function(circuits_app, function_params)
