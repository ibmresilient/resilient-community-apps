...
class TestExchangeDeleteEmails:
    ...
    @patch('fn_exchange.components.exchange_delete_emails.exchange_utils', side_effect=mocked_exchange_utils)
    ...
    def test_success(self, mock_utils, circuits_app, exchange_emails, exchange_hard_delete, exchange_folder_path, exchange_sender, exchange_start_date, exchange_end_date, expected_results):
