{
  ...
  "fields": [
    ...
    },
    {
      ...
      "tooltip": "Name of rule/playbook to schedule",
      "type_id": 11,
    ...
    },
    {
      ...
      "tooltip": "Optional parameters in json format for rule/playbook",
      "type_id": 11,
    ...
    },
    {
      ...
      "templates": [],
      "text": "row_id",
      "tooltip": "row information for datatable rules/playbooks",
      "type_id": 11,
    ...
    },
    {
      ...
      "templates": [],
      "text": "Schedule Rule/Playbook Parameters",
      "tooltip": "field1=value;field2=value format of optional rule/playbook parameters",
      "type_id": 6,
    ...
    },
    {
      ...
      "templates": [],
      "text": "Schedule Rule/Playbook Name",
      "tooltip": "Name of Rule/Playbook to schedule",
      "type_id": 6,
  ...
  "functions": [
    {
      ...
      "description": {
        "content": "Schedule a rule/playbook to run on a schedule. This rule/playbook will be executed for a given incident, artifact, task, etc.",
        "format": "text"
      },
      "destination_handle": "fn_scheduler",
      "display_name": "Scheduled Rule/Playbook Create",
    ...
    },
    {
      ...
      "destination_handle": "fn_scheduler",
      "display_name": "Scheduled Rule/Playbook List",
    ...
    },
    {
      ...
      "destination_handle": "fn_scheduler",
      "display_name": "Scheduled Rule/Playbook Remove",
    ...
    },
    {
      ...
      "destination_handle": "fn_scheduler",
      "display_name": "Scheduled Rule/Playbook Modify",
      ...
      "last_modified_time": 1650907622244,
    ...
    },
    {
      ...
      "description": {
        "content": "Pause a scheduled rule/playbook job",
        "format": "text"
      },
      "destination_handle": "fn_scheduler",
      "display_name": "Scheduled Rule/Playbook Pause",
    ...
    },
    {
      ...
      "destination_handle": "fn_scheduler",
      "display_name": "Scheduled Rule/Playbook Resume",
  ...
  "workflows": [
    ...
    },
    {
      ...
      "last_modified_by": "a@example.com",
      "last_modified_time": 1650977578716,
      "name": "Modify a Scheduled Job",
      "object_type": "scheduler_rules",
      "programmatic_name": "modify_a_scheduled_rule",
      "tags": [],
