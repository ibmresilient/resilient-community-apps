...
def init_scheduler(datastore_dir, threat_max, timezone):
    jobstores = {
...
def build_trigger(type, value, timezone):
    """
    ...
    if type == "cron":
        ...
        seconds = get_sleep_time_in_seconds(value)
        trigger = IntervalTrigger(seconds=seconds)

    elif type == "date":
        trigger = DateTrigger(run_date=value, timezone=timezone)
