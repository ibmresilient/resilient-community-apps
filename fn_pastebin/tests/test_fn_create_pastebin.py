...
class TestFnCreatePastebin:
    ...
    @pytest.mark.parametrize("pastebin_code, pastebin_name, pastebin_format, pastebin_privacy, pastebin_expiration, expected_results", [
        ("text", "text", "text", 123, "text", {"value": "xyz"}),
        ("text", "text", "text", 123, "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, pastebin_code, pastebin_name, pastebin_format, pastebin_privacy, pastebin_expiration, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "pastebin_code": pastebin_code,
            "pastebin_name": pastebin_name,
            "pastebin_format": pastebin_format,
            "pastebin_privacy": pastebin_privacy,
            "pastebin_expiration": pastebin_expiration
        }
