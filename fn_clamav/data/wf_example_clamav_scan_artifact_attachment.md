...
if response and response.stream[0] != "ERROR":
    ...
    if inputs.incident_id and inputs.artifact_id:
        noteText = """<br>ClamAV scan complete
                        ...
                        <br><b>Scan Status:</b> <b style="color: {3}">{4}</b></br>""".format
        (inputs.incident_id, inputs.artifact_id, file_name, color, response.stream[1])
        ...
        if inputs.task_id:
            noteText = """<br>ClamAV scan complete
                          ...
                          <br><b>Attachment Name:</b></br> '{2}'
                          <br><b>Scan Status:</b> <b style="color: {3}">{4}</b></br>""".format
            (inputs.task_id, inputs.attachment_id, file_name, color, response.stream[1])
            ...
            noteText = """<br>ClamAV scan complete
                          ...
                          <br><b>Attachment Name:</b></br> '{2}'
                          <br><b>Scan Status:</b> <b style="color: {3}">{4}</b></br>""".format
            (inputs.incident_id, inputs.attachment_id, file_name, color, response.stream[1])
    if inputs.task_id:
