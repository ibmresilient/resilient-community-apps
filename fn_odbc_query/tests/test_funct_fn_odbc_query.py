...
def call_fn_odbc_query_function(circuits, function_params, timeout=5):
...
class TestFnOdbcQuery:
    ...
    mock_inputs_1 = {
        "sql_query": {"type": "text", "content": "sample line one\nsample line two"},
        "sql_condition_value3": "sample text",
        "sql_condition_value1": "sample text",
        "sql_condition_value2": "sample text"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_fn_odbc_query_function(circuits_app, mock_inputs)
