...
class FunctionComponent(AppFunctionComponent):
    ...
    def _app_function(self, fn_inputs):
        ...
        required_parameters["task_id"] = None
        required_parameters["incident_id"] = 2098
        required_parameters["owners_list"] = "AdminSoarMS@5rf2xs.onmicrosoft.com"
        required_parameters["add_members_from"] = "incident"
        required_parameters["displayName"] = "newTeam"
        required_parameters["description"] = "sample incident"
        required_parameters["teams_description"] = "Sample team"
        required_parameters["additional_members"] = None
        ...
        if authenticated:
            try:
                group_manager = TeamsInterface(required_parameters)
                response = group_manager.create_teams(required_parameters)
