...
from fn_teams.lib import constants, configure_tab
...
class FunctionComponent(AppFunctionComponent):
    ...
    def __init__(self, opts):
        ...
        configure_tab.init_msteams_tab()
    ...
    def _app_function(self, fn_inputs):
        ...
        if authenticator:
            ...
            try:
                team_manager = GroupsInterface(required_parameters)

                response = team_manager.list_groups(getattr(fn_inputs, 'teams_filter', None))
