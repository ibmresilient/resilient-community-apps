...
class TestMcafeeEsmEditCase:
    ...
    @pytest.mark.parametrize("mcafee_edit_case_json, expected_results", [
        ({"type": "text", "content": "line1\nline2"}, {"value": "xyz"}),
        ({"type": "text", "content": "line1\nline2"}, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, mcafee_edit_case_json, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "mcafee_edit_case_json": mcafee_edit_case_json
        }
