...
def codegen_reload_data():
    ...
    return {
        ...
        "actions": [u"SentinelOne: Abort Disk Scan", u"SentinelOne: Add Agent to Data Table", u"SentinelOne: Connect Agent to Network", u"SentinelOne: Disconnect Agent From Network", u"SentinelOne: Get Hash Reputation", u"SentinelOne: Initiate Disk Scan", u"SentinelOne: Resolve Threat in SentinelOne", u"SentinelOne: Restart Agent", u"SentinelOne: Send Note to SentinelOne Threat", u"SentinelOne: Send SOAR Note to SentinelOne", u"SentinelOne: Shutdown Agent", u"SentinelOne: Update Agent in Data table", u"SentinelOne: Update Notes from SentinelOne", u"SentinelOne: Update Threat Status", u"SentinelOne: Write Agent Details to Note", u"SentinelOne: Write Threat Details to Note"],
