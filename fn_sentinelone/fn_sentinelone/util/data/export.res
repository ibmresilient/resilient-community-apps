{
  ...
  "actions": [
    ...
    },
    {
      ...
      "enabled": true,
      "export_key": "SentinelOne: Update Threat Analyst Verdict",
      "id": 28,
      "logic_type": "all",
      "message_destinations": [],
      "name": "SentinelOne: Update Threat Analyst Verdict",
      "object_type": "incident",
      "tags": [],
      "timeout_seconds": 86400,
      "type": 1,
      "uuid": "6e37ef6e-96db-4c62-b8a6-57e1732b5917",
      "view_items": [
        {
          "content": "Select the SentinelOne Analyst Verdict:",
          "element": "header",
          "field_type": null,
          "show_if": null,
    ...
    },
    {
      ...
      "enabled": true,
      "export_key": "SentinelOne: Update Threat Status",
      "id": 29,
      "logic_type": "all",
      "message_destinations": [],
      ...
      "view_items": [
        {
          "content": "Select the SentinelOne Threat Status:",
          "element": "header",
          "field_type": null,
          "show_if": null,
          "show_link_header": false,
  ...
  "functions": [
    ...
    },
    {
      ...
      "description": {
        "content": "Update the verdict of a threat in SentinelOne.",
        "format": "text"
      },
      "destination_handle": "fn_sentinelone",
      "display_name": "SentinelOne: Update Threat Analyst Verdict",
      "export_key": "sentinelone_update_threat_analyst_verdict",
      "id": 12,
      "last_modified_by": {
        "display_name": "Admin User",
        "id": 1,
      ...
      "last_modified_time": 1637518573205,
      "name": "sentinelone_update_threat_analyst_verdict",
      "tags": [],
      "uuid": "afdad45b-0075-4ee1-a9b7-47b0d12b1e11",
      "version": 3,
      "view_items": [
        {
          "content": "f0f85d50-0f6e-4a99-9b5c-a568c69772ce",
      ...
      "workflows": [
        {
          ...
          "name": "SentinelOne: Update Threat Analyst Verdict",
          "object_type": "incident",
          "programmatic_name": "sentinelone_update_threat_analyst_verdict",
          "tags": [],
          "uuid": null,
          "workflow_id": 13
        }
    ...
    },
    {
      ...
      "description": {
        "content": "Update the status of a threat in SentinelOne.",
        "format": "text"
      },
      "destination_handle": "fn_sentinelone",
      ...
      "last_modified_time": 1637589765267,
  ...
  "workflows": [
    {
      ...
      "export_key": "sentinelone_resolve_threat_in_sentinelone",
      "last_modified_by": "admin@example.com",
      "last_modified_time": 1638564637014,
      "name": "SentinelOne: Resolve Threat in SentinelOne",
      "object_type": "incident",
      "programmatic_name": "sentinelone_resolve_threat_in_sentinelone",
      "tags": [],
    ...
    },
    {
      ...
      "content": {
        "version": 8,
        "workflow_id": "sentinelone_update_threat_analyst_verdict",
        "xml": "\u003c?xml version=\"1.0\" encoding=\"UTF-8\"?\u003e\u003cdefinitions xmlns=\"http://www.omg.org/spec/BPMN/20100524/MODEL\" xmlns:bpmndi=\"http://www.omg.org/spec/BPMN/20100524/DI\" xmlns:omgdc=\"http://www.omg.org/spec/DD/20100524/DC\" xmlns:omgdi=\"http://www.omg.org/spec/DD/20100524/DI\" xmlns:resilient=\"http://resilient.ibm.com/bpmn\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" targetNamespace=\"http://www.camunda.org/test\"\u003e\u003cprocess id=\"sentinelone_update_threat_analyst_verdict\" isExecutable=\"true\" name=\"SentinelOne: Update Threat Analyst Verdict\"\u003e\u003cdocumentation\u003eUpdate the analyst verdict of a threat in SentinelOne.  Write the results to a notes.\u003c/documentation\u003e\u003cstartEvent id=\"StartEvent_155asxm\"\u003e\u003coutgoing\u003eSequenceFlow_1d0iacc\u003c/outgoing\u003e\u003c/startEvent\u003e\u003cserviceTask id=\"ServiceTask_0ev2yqa\" name=\"SentinelOne: Update Threat Analys...\" resilient:type=\"function\"\u003e\u003cextensionElements\u003e\u003cresilient:function uuid=\"afdad45b-0075-4ee1-a9b7-47b0d12b1e11\"\u003e{\"inputs\":{\"e0ed407a-e9e0-40f8-b46b-5167eab16a70\":{\"input_type\":\"static\",\"static_input\":{\"multiselect_value\":[],\"select_value\":\"55fe7fb5-9ad9-4588-bc2b-cac8cf797a2c\"}}},\"post_processing_script\":\"so_inputs = results.get(\\\"inputs\\\")\\nthreat_id = so_inputs.get(\\\"sentinelone_threat_id\\\")\\nverdict = so_inputs.get(\\\"sentinelone_threat_analyst_verdict\\\")\\nnote = u\\\"\u0026lt;b\u0026gt;SentinelOne: Update Threat Analyst Verdict \u0026lt;/b\u0026gt;\u0026lt;br\u0026gt;  SentinelOne Threat Id: {0}\\\".format(threat_id)\\ncontent = results.get(\\\"content\\\")\\nif content:\\n  data = content.get(\\\"data\\\")\\n  if data:\\n    if int(data.get(\\\"affected\\\")) \u0026lt;= 0:\\n      note = u\\\"{0} Analyst Verdict \u0026lt;b\u0026gt;{1}\u0026lt;/b\u0026gt; NOT updated in SentinelOne threat.\\\".format(note, verdict)\\n    else:\\n      note = u\\\"{0} Analyst Verdict \u0026lt;b\u0026gt;{1}\u0026lt;/b\u0026gt; updated in SentinelOne threat\\\".format(note, verdict)\\n  else:\\n    note = u\\\"{0} Analyst Verdict \u0026lt;b\u0026gt;{1}\u0026lt;/b\u0026gt; NOT updated. No \u0027data\u0027 returned from function\\\".format(note, verdict)\\nelse:\\n    note = u\\\"{0} Analyst Verdict \u0026lt;b\u0026gt;{1}\u0026lt;/b\u0026gt; NOT updated. No content returned from function\\\".format(note, verdict)  \\n\\nincident.addNote(helper.createRichText(note))\",\"post_processing_script_language\":\"python3\",\"pre_processing_script\":\"inputs.sentinelone_threat_id = incident.properties.sentinelone_threat_id\\ninputs.sentinelone_threat_analyst_verdict = rule.properties.sentinelone_threat_analyst_verdict\",\"pre_processing_script_language\":\"python3\"}\u003c/resilient:function\u003e\u003c/extensionElements\u003e\u003cincoming\u003eSequenceFlow_1d0iacc\u003c/incoming\u003e\u003coutgoing\u003eSequenceFlow_1rikysl\u003c/outgoing\u003e\u003c/serviceTask\u003e\u003csequenceFlow id=\"SequenceFlow_1d0iacc\" sourceRef=\"StartEvent_155asxm\" targetRef=\"ServiceTask_0ev2yqa\"/\u003e\u003cendEvent id=\"EndEvent_1fdhas1\"\u003e\u003cincoming\u003eSequenceFlow_1rikysl\u003c/incoming\u003e\u003c/endEvent\u003e\u003csequenceFlow id=\"SequenceFlow_1rikysl\" sourceRef=\"ServiceTask_0ev2yqa\" targetRef=\"EndEvent_1fdhas1\"/\u003e\u003ctextAnnotation id=\"TextAnnotation_1kxxiyt\"\u003e\u003ctext\u003eStart your workflow here\u003c/text\u003e\u003c/textAnnotation\u003e\u003cassociation id=\"Association_1seuj48\" sourceRef=\"StartEvent_155asxm\" targetRef=\"TextAnnotation_1kxxiyt\"/\u003e\u003ctextAnnotation id=\"TextAnnotation_0opn7vx\"\u003e\u003ctext\u003e\u003c![CDATA[Input: SOAR Incident Id and the SentinelOne Threat Id\n]]\u003e\u003c/text\u003e\u003c/textAnnotation\u003e\u003cassociation id=\"Association_1mluitk\" sourceRef=\"ServiceTask_0ev2yqa\" targetRef=\"TextAnnotation_0opn7vx\"/\u003e\u003c/process\u003e\u003cbpmndi:BPMNDiagram id=\"BPMNDiagram_1\"\u003e\u003cbpmndi:BPMNPlane bpmnElement=\"undefined\" id=\"BPMNPlane_1\"\u003e\u003cbpmndi:BPMNShape bpmnElement=\"StartEvent_155asxm\" id=\"StartEvent_155asxm_di\"\u003e\u003comgdc:Bounds height=\"36\" width=\"36\" x=\"162\" y=\"188\"/\u003e\u003cbpmndi:BPMNLabel\u003e\u003comgdc:Bounds height=\"0\" width=\"90\" x=\"157\" y=\"223\"/\u003e\u003c/bpmndi:BPMNLabel\u003e\u003c/bpmndi:BPMNShape\u003e\u003cbpmndi:BPMNShape bpmnElement=\"TextAnnotation_1kxxiyt\" id=\"TextAnnotation_1kxxiyt_di\"\u003e\u003comgdc:Bounds height=\"30\" width=\"100\" x=\"99\" y=\"254\"/\u003e\u003c/bpmndi:BPMNShape\u003e\u003cbpmndi:BPMNEdge bpmnElement=\"Association_1seuj48\" id=\"Association_1seuj48_di\"\u003e\u003comgdi:waypoint x=\"169\" xsi:type=\"omgdc:Point\" y=\"220\"/\u003e\u003comgdi:waypoint x=\"153\" xsi:type=\"omgdc:Point\" y=\"254\"/\u003e\u003c/bpmndi:BPMNEdge\u003e\u003cbpmndi:BPMNShape bpmnElement=\"ServiceTask_0ev2yqa\" id=\"ServiceTask_0ev2yqa_di\"\u003e\u003comgdc:Bounds height=\"80\" width=\"100\" x=\"529\" y=\"166\"/\u003e\u003c/bpmndi:BPMNShape\u003e\u003cbpmndi:BPMNEdge bpmnElement=\"SequenceFlow_1d0iacc\" id=\"SequenceFlow_1d0iacc_di\"\u003e\u003comgdi:waypoint x=\"198\" xsi:type=\"omgdc:Point\" y=\"206\"/\u003e\u003comgdi:waypoint x=\"529\" xsi:type=\"omgdc:Point\" y=\"206\"/\u003e\u003cbpmndi:BPMNLabel\u003e\u003comgdc:Bounds height=\"14\" width=\"0\" x=\"363.5\" y=\"184\"/\u003e\u003c/bpmndi:BPMNLabel\u003e\u003c/bpmndi:BPMNEdge\u003e\u003cbpmndi:BPMNShape bpmnElement=\"EndEvent_1fdhas1\" id=\"EndEvent_1fdhas1_di\"\u003e\u003comgdc:Bounds height=\"36\" width=\"36\" x=\"899\" y=\"188\"/\u003e\u003cbpmndi:BPMNLabel\u003e\u003comgdc:Bounds height=\"14\" width=\"0\" x=\"917\" y=\"227\"/\u003e\u003c/bpmndi:BPMNLabel\u003e\u003c/bpmndi:BPMNShape\u003e\u003cbpmndi:BPMNEdge bpmnElement=\"SequenceFlow_1rikysl\" id=\"SequenceFlow_1rikysl_di\"\u003e\u003comgdi:waypoint x=\"629\" xsi:type=\"omgdc:Point\" y=\"206\"/\u003e\u003comgdi:waypoint x=\"899\" xsi:type=\"omgdc:Point\" y=\"206\"/\u003e\u003cbpmndi:BPMNLabel\u003e\u003comgdc:Bounds height=\"14\" width=\"0\" x=\"764\" y=\"184\"/\u003e\u003c/bpmndi:BPMNLabel\u003e\u003c/bpmndi:BPMNEdge\u003e\u003cbpmndi:BPMNShape bpmnElement=\"TextAnnotation_0opn7vx\" id=\"TextAnnotation_0opn7vx_di\"\u003e\u003comgdc:Bounds height=\"30\" width=\"100\" x=\"367\" y=\"52\"/\u003e\u003c/bpmndi:BPMNShape\u003e\u003cbpmndi:BPMNEdge bpmnElement=\"Association_1mluitk\" id=\"Association_1mluitk_di\"\u003e\u003comgdi:waypoint x=\"536\" xsi:type=\"omgdc:Point\" y=\"169\"/\u003e\u003comgdi:waypoint x=\"434\" xsi:type=\"omgdc:Point\" y=\"82\"/\u003e\u003c/bpmndi:BPMNEdge\u003e\u003c/bpmndi:BPMNPlane\u003e\u003c/bpmndi:BPMNDiagram\u003e\u003c/definitions\u003e"
      },
      "content_version": 8,
      "creator_id": "admin@example.com",
      "description": "Update the analyst verdict of a threat in SentinelOne.  Write the results to a notes.",
      "export_key": "sentinelone_update_threat_analyst_verdict",
      "last_modified_by": "admin@example.com",
      "last_modified_time": 1637518755919,
      "name": "SentinelOne: Update Threat Analyst Verdict",
      "object_type": "incident",
      "programmatic_name": "sentinelone_update_threat_analyst_verdict",
      "tags": [],
      "uuid": "d7a2dd0d-c5fa-4945-8bee-8a4a482d29cc",
      "workflow_id": 13
    },
    {
      "actions": [],
    ...
    },
    {
      ...
      "last_modified_by": "admin@example.com",
      "last_modified_time": 1638378914957,
      "name": "SentinelOne: Download From Cloud",
      "object_type": "incident",
      "programmatic_name": "sentinelone_download_threat_from_cloud",
      "tags": [],
    ...
    },
    {
      ...
      "export_key": "sentinelone_update_notes_from_sentinelone",
      "last_modified_by": "admin@example.com",
      "last_modified_time": 1637429645490,
      "name": "SentinelOne: Update Notes from SentinelOne",
      "object_type": "incident",
      "programmatic_name": "sentinelone_update_notes_from_sentinelone",
      "tags": [],
    ...
    },
    {
      ...
      "export_key": "sentinelone_send_soar_note_to_sentinelone",
      "last_modified_by": "admin@example.com",
      "last_modified_time": 1638289501252,
      "name": "SentinelOne: Send SOAR note to SentinelOne",
      "object_type": "note",
      "programmatic_name": "sentinelone_send_soar_note_to_sentinelone",
      "tags": [],
