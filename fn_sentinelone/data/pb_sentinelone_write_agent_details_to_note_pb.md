...
# Playbook - SentinelOne: Write Agent Details to Note (PB)
...
---
## Local script - SentinelOne: Prepare results for JSON Converter Script

### Description
Prepare the results from Get Agent Details to send to JSON converter script.
