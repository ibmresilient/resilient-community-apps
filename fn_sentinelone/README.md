...
| SentinelOne: Restart Agent Endpoint (PB) | Restart an agent endpoint managed by SentinelOne. | Manual | sentinelone_agents_dt | `enabled` | `sentinelone_agents_dt.sentinelone_dt_is_active equals True AND sentinelone_agents_dt.sentinelone_dt_network_status equals connected` |
...
| SentinelOne: Shutdown Agent Endpoint (PB) | Shutdown an agent endpoint managed by SentinelOne. | Manual | sentinelone_agents_dt | `enabled` | `sentinelone_agents_dt.sentinelone_dt_is_active equals True AND sentinelone_agents_dt.sentinelone_dt_network_status equals connected` |
