...
"""Generate the SOAR customizations required for fn_hibp"""
...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [
            u"have_i_been_pwned_get_breaches",
            u"have_i_been_pwned_get_pastes"
        ],
        "workflows": [
            u"have_i_been_pwned_search"
        ],
        "actions": [
            u"Have I Been Pwned Search"
        ],
        "incident_fields": [],
