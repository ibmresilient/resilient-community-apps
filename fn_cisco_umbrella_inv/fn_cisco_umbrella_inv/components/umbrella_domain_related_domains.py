    ...
    def _umbrella_domain_related_domains_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            if not hasattr(self, '_domain'):
               raise ValueError("Parameters 'umbinv_domain' was not processed correctly")
            ...
            if rtn["found"] is None or str(rtn["found"]).lower() == 'false':
                ...
                results = {"related_domains": json.loads(json.dumps(rtn)), "domain_name": self._domain,
