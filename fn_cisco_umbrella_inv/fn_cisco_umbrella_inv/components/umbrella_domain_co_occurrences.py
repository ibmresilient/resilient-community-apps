...
""" SOAR functions component to run an Umbrella investigate Query - Co-Occurrences for a Domain against a Cisco
Umbrella server """
...
FN_NAME = "umbrella_domain_co_occurrences"

class FunctionComponent(AppFunctionComponent):
    """Component that implements SOAR function 'umbrella_domain_co_occurrences' of
    ...
    in JSON format similar to the following.
        ...
        {'domain_name': 'googlevideo.com',
         ...
         'cooccurrences': { 'found': True,
                            'domain_name': 'googlevideo.com'
                            'pfs2': [['gowatchfreemovies.to', 0.14300200812663327],
                            ['www.mc-skv.com', 0.12482579576302438],
                            ['r5---sn-n4v7sn7l.googlevideo.com', 0.0064511764392265955],
                            ['sage200.co.uk', 0.006262067692875829],
                            ['demon.co.uk', 0.005126508408778887]]}
        }
    """
    ...
    def _app_function(self, fn_inputs):
        """Function: SOAR Function: Cisco Umbrella Investigate for Co-Occurrences for a Domain."""
        try:
            ...
            rtn = invClient.make_api_call("GET", URIs.get("cooccurrences").format(domain))
            ...
            if not rtn.get("found", False):
                ...
                results = {"cooccurrences": rtn, "domain_name": domain,
                           "query_execution_time": query_execution_time}
                yield self.status_message(f"Returning 'cooccurrences' results for domain '{domain}'.")
