...
def call_umbrella_threat_grid_samples_function(circuits, function_params, timeout=5):
...
class TestUmbrellaThreatGridSamples:
    ...
    mock_inputs_1 = {
        "umbinv_offset": 0,
        "umbinv_sortby": "score",
        "umbinv_resource": "google.com",
        "umbinv_limit": 10
    }

    expected_results_1 = mock_umbrella.samples_return
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        with patch("fn_cisco_umbrella_inv.components.umbrella_threat_grid_samples.investigateClient") as patch_client:
            patch_client.return_value = mock_umbrella.mock_client()
            results = call_umbrella_threat_grid_samples_function(circuits_app, mock_inputs)
            assert(expected_results == results.get("content", {}).get("thread_grid_samples", {}))
