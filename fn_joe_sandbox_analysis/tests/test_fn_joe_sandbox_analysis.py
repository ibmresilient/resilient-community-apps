...
FUNCTION_NAME = "fn_joe_sandbox_analysis"
...
def call_fn_joe_sandbox_analysis_function(circuits, function_params, timeout=5):
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("fn_joe_sandbox_analysis_result", parent=evt, timeout=timeout)
        assert event
...
#
#        results = call_fn_joe_sandbox_analysis_function(circuits_app, mock_inputs)
