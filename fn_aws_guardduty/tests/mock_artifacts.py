    ...
    response = {
        ...
        "get_findings": (
            {'ResponseMetadata': {'RequestId': 'bad216aa-23fc-41d5-9c3e-bf0aa6188aa9', 'HTTPStatusCode': 200,
                                  ...
                                  'RetryAttempts': 0}, 'Findings': [{'AccountId': 'xxxxyyyyzzzz',
                                                                     'Arn': 'arn:aws:guardduty:us-west-2:xxxxyyyyzzzz:detector/f2baedb0ac74f8f42fc929e15f56da6a/finding/60baffd3f9042e38640f2300d5c5a631',
                                                                          ...
                                                                          'PublicAccess': {'PermissionConfiguration': {
                                                                              ...
                                                                              'AccountLevelPermissions': {
                                                                                  ...
                                                                                  'InstanceDetails': {
                                                                                      ...
                                                                                      'IamInstanceProfile': {
                                                                                          'Arn': 'arn:aws:iam::xxxxyyyyzzzz:example/instance/profile',
    ...
    response = {
        ...
        "refresh_finding_no_artifacts_py2": (
            {u'discovered_date': u'2020-11-25T13:46:37.960Z', u'description': {
             ...
             u'severity_code': u'Low', u'comments': [], u'properties': {u'aws_guardduty_resource_type': u'S3Bucket',
                                                                        ...
                                                                        u'aws_guardduty_finding_arn': u'arn:aws:guardduty:us-west-2:xxxxyyyyzzzz:detector/f2baedb0ac74f8f42fc929e15f56da6a/finding/60baffd3f9042e38640f2300d5c5a631',
        ...
        "refresh_finding_to_json": (
            {'timestamp': '2021-01-22 15:45:26',
             'region': 'us-west-2',
             'finding': {'AccountId': 'xxxxyyyyzzzz',
                         'Arn': 'arn:aws:guardduty:us-west-2:xxxxyyyyzzzz:detector/f2baedb0ac74f8f42fc929e15f56da6a/finding/60baffd3f9042e38640f2300d5c5a631',
                         'CreatedAt': '2020-11-25T13:46:37.960Z',
                         'Description': 'An API was used to access a bucket from an IP address on a custom threat list.',
