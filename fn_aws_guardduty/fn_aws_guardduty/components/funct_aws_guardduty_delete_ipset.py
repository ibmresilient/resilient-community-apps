...
"""Function to delete a IPSet for AWS GuardDuty"""
...
class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'aws_guardduty_delete_ipset'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Deletes the IPSet specified by the IPSet ID.
        Inputs:
        ...
        try:
            ...
            incident_response = aws_gd.delete("delete_ip_set", **input_parameters_specified)
