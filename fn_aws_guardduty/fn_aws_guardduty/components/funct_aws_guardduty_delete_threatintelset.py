...
"""Function to delete a ThreatIntelSet for AWS GuardDuty"""
...
class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'aws_guardduty_delete_threatintelset'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Deletes the ThreatIntelSet specified by the ThreatIntelSet ID.
        Inputs:
        ...
        try:
            ...
            incident_response = aws_gd.delete("delete_threat_intel_set", **input_parameters_specified)
