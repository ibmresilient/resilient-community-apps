...
"""Function to get all details about a IPSet for AWS GuardDuty"""
...
REQUIRED_FIELDS = ["aws_gd_ip_set_id", "aws_gd_detector_id", "aws_gd_region"]

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'aws_guardduty_get_ipset'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Retrieves the IPSet specified by the IPSetId.
        Inputs:
        ...
        try:
            ...
            incident_response = aws_gd.get("get_ip_set", **input_parameters_specified)
