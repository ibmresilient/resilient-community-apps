...
"""Function to create a new IPSet for AWS GuardDuty"""
...
class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'aws_guardduty_create_ipset'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        try:
            ...
            incident_response = aws_gd.post("create_ip_set", **input_parameters_specified)
