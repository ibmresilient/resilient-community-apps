...
"""Function to list all ThreatIntelSets for AWS GuardDuty"""
...
class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'aws_guardduty_list_threatintelset'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Lists the ThreatIntelSets of the GuardDuty service specified by the detector ID.
        Inputs:
        ...
        try:
            ...
            incident_response = aws_gd.get("list_threat_intel_sets", **input_parameters_specified)
