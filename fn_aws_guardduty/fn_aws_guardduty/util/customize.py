...
def codegen_reload_data():
    ...
    return {
        ...
        "actions": [u"Example: AWS GuardDuty: Archive Finding", u"Example: AWS GuardDuty: Refresh Finding"],
        "incident_fields": [u"aws_guardduty_finding_arn", u"aws_guardduty_archived", u"aws_guardduty_severity", u"aws_guardduty_finding_id", u"aws_guardduty_finding_type", u"aws_guardduty_resource_type", u"aws_guardduty_detector_id", u"aws_guardduty_finding_updated_at", u"aws_guardduty_region", u"aws_guardduty_count"],
        "incident_artifact_types": [u"aws_iam_access_key_id", u"aws_s3_bucket_name", u"aws_iam_user_name"],
        "datatables": [u"gd_resource_affected", u"gd_finding_overview", u"gd_s3_bucket_details", u"gd_action_details", u"gd_access_key_details", u"gd_instance_details"],
        "automatic_tasks": [],
        "scripts": []
    }
