...
def codegen_reload_data():
    ...
    return {
        ...
        "incident_fields": [u"aws_guardduty_trigger_refresh", u"aws_guardduty_detector_id", u"aws_guardduty_finding_arn", u"aws_guardduty_count", u"aws_guardduty_resource_type", u"aws_guardduty_finding_updated_at", u"aws_guardduty_archived", u"aws_guardduty_finding_type", u"aws_guardduty_region", u"aws_guardduty_finding_id"],
        "incident_artifact_types": [u"aws_iam_access_key_id", u"aws_s3_bucket_name", u"aws_iam_user_name"],
        "datatables": [u"gd_resource_affected", u"gd_action_details", u"gd_s3_bucket_details"],
        "automatic_tasks": [],
        "scripts": []
    }
