...
| ----------------- | -------- | ------------ | ------- | ----------- |
| Description | `salesforce_case_description` | text | - | Optional |
| Include SOAR Tasks | `include_soar_tasks` | boolean | Select whether  SOAR tasks are included in the Salesforce case | Optional |
| Internal Comments | `salesforce_case_internal_comments` | text | - | Optional |
| Priority | `salesforce_case_priority` | select | - | Optional |
| Status | `salesforce_case_status` | select | - | Optional |
| Subject | `salesforce_case_subject` | text | - | Optional |
| Type | `salesforce_case_type` | select | - | Optional |
