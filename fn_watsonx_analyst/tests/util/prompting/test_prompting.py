...
class TestPrompting:
    ...
    def setup_method(self):
        ...
        model_config_path_test = os.path.abspath(
            os.path.join(
                current_dir,
                "../../../../fn_watsonx_analyst/fn_watsonx_analyst/util/model_config.json",
            )
        )
    ...
    def test_message(self):
        ...
        message: MessagePayload = {
            "role": "assistant",
            "content": "This incident resulted in a data security breach caused by a faulty fail2ban instance, allowing an attacker access to the system.",
        }

        result = Prompting().build_prompt(query, context, [message, {}])
    ...
    def test_format(self):
        ...
        assert (
            ...
            .__contains__(
                "Analyze the information shared above for application/json data"
            )
        )
