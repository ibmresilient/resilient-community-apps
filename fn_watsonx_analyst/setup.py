...
setup(
    ...
    long_description="""Leverage generative AI with watsonx.ai for artifact and attachment scanning, incident summarization and Q&A (Questions & Answers), and generic watsonx.ai text generation.""",
    install_requires=["resilient-circuits>=51.0.2.0.0", "scikit-learn==1.5.2", "tiktoken==0.8.0", "py3langid==0.3.0", "nh3==0.2.19", "jsonpath-ng==1.7.0", "faiss-cpu==1.9.0", "numpy==2.2.0", "tika==2.6.0","beautifulsoup4==4.12.3", "markdown2==2.5.3", "pydantic==2.10.6", "PyYAML==6.0.2"],
