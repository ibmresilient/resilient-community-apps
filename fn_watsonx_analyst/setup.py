...
setup(
    ...
    install_requires=['numpy==2.2.0', 'mail-parser==4.1.2', 'xlrd==2.0.1', 'py3langid==0.3.0', 'openpyxl==3.1.5', 'unoconv==0.9.0', 'markdown2==2.5.3', 'python-docx==1.1.2', 'jsonpath-ng==1.7.0', 'pdf2image==1.17.0', 'sentence-transformers==3.3.1', 'python-pptx==1.0.2', 'nh3==0.2.19', 'resilient-circuits>=51.0.2.0.0', 'scikit-learn==1.5.2', 'beautifulsoup4==4.12.3', 'pillow==11.1.0', 'faiss-cpu==1.9.0', 'pypdf==6.6.2', 'ics==0.7.2', 'pydantic==2.10.6', 'pytesseract==0.3.13', 'tiktoken==0.8.0', 'bs4==0.0.2', 'PyYAML==6.0.2'],
