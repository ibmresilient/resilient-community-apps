...
<small style="font-size: 12px;"><span style="display: table-cell; font-size: 12px; padding-left: 1em;"><span style="color: lightgrey;">GenAI Contribution by {self._get_name()} for {self.purpose.value}</span><br><span>Using {self.model_id} at {self.created_at}</span></small></div></div>
"""
