...
FUNCTION_NAME = "attachment_to_base64"
...
def call_attachment_to_base64_function(circuits, function_params, timeout=10):
    ...
    circuits.manager.fire(SubmitTestFunction("attachment_to_base64", function_params))
    event = circuits.watcher.wait("attachment_to_base64_result", timeout=timeout)
    assert event
