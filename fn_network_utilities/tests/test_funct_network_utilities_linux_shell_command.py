...
FUNCTION_NAME = "network_utilities_linux_shell_command"
...
def call_network_utilities_linux_shell_command_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("network_utilities_linux_shell_command", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("network_utilities_linux_shell_command_result", parent=evt, timeout=timeout)
        assert event
...
class TestNetworkUtilitiesLinuxShellCommand:
    """ Tests for the network_utilities_linux_shell_command function"""
    ...
    def test_remote_failures(self, circuits_app, shell_remote, shell_command, shell_param1):
        with pytest.raises(Exception):
            ...
            results = call_network_utilities_linux_shell_command_function(circuits_app, function_params)
