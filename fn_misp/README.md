...
The purpose of this package is to allow the creation of an event in MISP from an incident in SOAR.
...
try:
  misp_type = soar_to_misp_map[artifact.type]
