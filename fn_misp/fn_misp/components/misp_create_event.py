...
class FunctionComponent(AppFunctionComponent):
    ...
    def _app_function(self, fn_inputs):
        ...
        misp_analysis_level = getattr(
            fn_inputs, "misp_analysis_level")  # number
        ...
        events = misp_helper.create_misp_event(
            misp_client, misp_distribution, misp_threat_level, misp_analysis_level, misp_event_name)
