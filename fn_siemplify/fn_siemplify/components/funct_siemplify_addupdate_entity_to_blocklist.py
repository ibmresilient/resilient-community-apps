...
FN_NAME = "siemplify_addupdate_entity_to_blocklist"


class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'siemplify_addupdate_entity_to_blocklist'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results, error_msg = siemplify_env.add_update_blocklist(fn_inputs_dict) # returns blank when complete
