...
class TestFnSepScanEndpoints:
    ...
    @pytest.mark.parametrize("sep_group_ids, sep_computer_ids, sep_scan_type, sep_file_path, sep_sha256, set_description, expected_results", [
        ("text", "text", 'CUSTOM_SCAN', "text", "text", "text", {"value": "xyz"}),
        ("text", "text", 'FULL_SCAN', "text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, sep_group_ids, sep_computer_ids, sep_scan_type, sep_file_path, sep_sha256, set_description, expected_results):
