...
"""Tests for fn_sep_get_command_status function."""
...
class TestFnSepGetCommandStatus:
    ...
    def test_success(self, mock_get, circuits_app, sep_incident_id, sep_commandid, sep_order, sep_pageindex,
        ...
        assert expected_results_1 == content.get("total_ep_count")
        assert expected_results_2 == content.get("total_not_completed")
        assert expected_results_3 == content.get("total_match_count")
