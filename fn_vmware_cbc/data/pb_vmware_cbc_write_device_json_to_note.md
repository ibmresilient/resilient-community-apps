...
# Playbook - VMware CBC: Write Device JSON to Note
...
## Local script - VMware CBC: write Get Device by ID results to a note

### Description
Prepare device results to pass to JSON conversion script
