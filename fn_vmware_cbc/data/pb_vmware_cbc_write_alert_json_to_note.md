...
# Playbook - VMware CBC: Write Alert JSON to Note
...
## Local script - VMware CBC: write Get Alert by ID results to a note

### Description
Prepare alert results to pass to JSON conversion script
