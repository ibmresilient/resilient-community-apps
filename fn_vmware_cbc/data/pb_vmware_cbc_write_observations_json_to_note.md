...
# Playbook - VMware CBC: Write Observations JSON to Note
...
## Local script - VMware CBC: write observations detail job results to a note

### Description
Write observations detail job function results to a note
