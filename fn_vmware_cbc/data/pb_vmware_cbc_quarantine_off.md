...
# Playbook - VMware CBC: Quarantine OFF
...
`vmware_cbc_device_dt.cbc_device_id has_a_value AND vmware_cbc_device_dt.cbc_device_quarantined equals True`
...
## Local script - VMware CBC: Quarantine Device OFF
