...
class TestFnAmpGetComputers:
    ...
    @pytest.mark.parametrize("amp_group_guid, amp_limit, amp_hostname, amp_internal_ip, amp_external_ip, expected_results", [
        ("text", 123, "text", "text", "text", {"value": "xyz"}),
        ("text", 123, "text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, amp_group_guid, amp_limit, amp_hostname, amp_internal_ip, amp_external_ip, expected_results):
