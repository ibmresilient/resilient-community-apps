...
class TestFnAmpGetActivity:
    ...
    @pytest.mark.parametrize("amp_q, amp_limit, amp_offset, expected_results", [
        ("text", 123, 123, {"value": "xyz"}),
        ("text", 123, 123, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, amp_q, amp_limit, amp_offset, expected_results):
