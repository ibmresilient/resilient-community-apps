...
FUNCTION_NAME = "soar_utils_artifact_hash"
...
def call_soar_utilities_artifact_hash_function(circuits, function_params, timeout=10):
...
class TestUtilitiesArtifactHash:
    ...
    def test_success(self, circuits_app, incident_id, artifact_id, expected_results):
        ...
        results = call_soar_utilities_artifact_hash_function(circuits_app, function_params)
