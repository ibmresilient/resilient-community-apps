...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [u"randori_get_detections_of_target", u"randori_get_target", u"randori_send_note_as_comment_to_target", u"randori_update_notes_from_randori_target", u"randori_update_target_impact_score", u"randori_update_target_status"],
        "workflows": [],
        "actions": [],
