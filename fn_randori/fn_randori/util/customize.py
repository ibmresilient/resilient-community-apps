...
def codegen_reload_data():
    ...
    return {
        ...
        "workflows": [],
        "actions": [],
        "incident_fields": [u"randori_target_affiliation_state", u"randori_target_authority", u"randori_target_id", u"randori_target_impact_score", u"randori_target_link", u"randori_target_name", u"randori_target_perspective_name", u"randori_target_status", u"randori_target_tags", u"randori_target_tech_category", u"randori_target_temptation", u"randori_target_vendor", u"randori_target_version"],
