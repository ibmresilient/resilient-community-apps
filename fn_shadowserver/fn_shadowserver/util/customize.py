...
"""Generate the Resilient customizations required for fn_shadowserver"""
...
def codegen_reload_data():
    """
    Parameters required reload codegen for the fn_shadowserver package
    """
    return {
        "package": u"fn_shadowserver",
