...
def codegen_reload_data():
    ...
    return {
        ...
        "actions": [u"(Example) McAfee Publish to DXL (Set TIE Reputation Known Malicious)", u"(Example) McAfee Publish to DXL (Tag System Shut Down)"],
        "incident_fields": [],
...
Y2lkZW50X3R5cGVzIjogW3sidXBkYXRlX2RhdGUiOiAxNjAyODc3MzAxMDMwLCAiY3JlYXRlX2Rh
dGUiOiAxNjAyODc3MzAxMDMwLCAidXVpZCI6ICJiZmVlYzJkNC0zNzcwLTExZTgtYWQzOS00YTAw
