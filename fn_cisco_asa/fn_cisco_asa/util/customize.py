...
def codegen_reload_data():
    ...
    return {
        ...
        "actions": [u"Cisco ASA: Add IPv4Address to Network Object Group", u"Cisco ASA: Add IPv4FQDN to Network Object Group", u"Cisco ASA: Add IPv4Network to Network Object Group", u"Cisco ASA: Add IPv4Range to Network Object Group", u"Cisco ASA: Add IPv6Network to Network Object Group", u"Cisco ASA: Get Network Object Details", u"Cisco ASA: Get Network Object Group", u"Cisco ASA: Remove Network Object from Network Object Group"],
        "incident_fields": [],
