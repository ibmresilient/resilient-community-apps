...
def codegen_reload_data():
    ...
    return {
        ...
        "workflows": [u"cisco_asa_add_artifact_to_network_object_group", u"cisco_asa_add_ip_to_network_object_group", u"cisco_asa_add_network_object_to_network_object_group", u"cisco_asa_get_network_object_details", u"cisco_asa_get_network_object_group", u"cisco_asa_remove_network_object_from_network_object_group"],
...
def customization_data(client=None):
    ...
    - Workflows:
        - cisco_asa_add_artifact_to_network_object_group
        - cisco_asa_add_ip_to_network_object_group
        - cisco_asa_add_network_object_to_network_object_group
        - cisco_asa_get_network_object_details
