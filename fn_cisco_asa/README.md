...
# IBM Security QRadar SOAR Functions for Cisco ASA
...
- [Requirements](#requirements)
  - [IBM SOAR platform](#soar-platform)
...
-->
This app supports the IBM Security QRadar SOAR Platform and the IBM Cloud Pak for Security.
