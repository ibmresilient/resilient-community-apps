<!--
  ...
  This file was generated with resilient-sdk v51.0.8.0.30103
...
- [Function - Call REST API](#function---call-rest-api)
- [Playbooks](#playbooks)
...
| 1.3.2 | 05/2026 | Added dual authentication support (header + body) for OAuth 2.0. Added support for Python 3.11 and 3.12|
...
* SOAR platform >= `51.0.7.0.20620`.
* The app is in a container-based format (available from the AppExchange as a `zip` file).

If deploying to a SOAR platform with an integration server, the requirements are:
* SOAR platform >= `51.0.7.0.20620`.
* The app is in the older integration format (available from the AppExchange as a `zip` file which contains a `tar.gz` file).
* Integration server is running `resilient-circuits >= 51.0.1.0`.
...
When `client_id` and `client_secret` are provided, the function automatically sends credentials using both HTTP Basic Authorization header and request body parameters for maximum compatibility with OAuth 2.0 providers.
...
| ------------- | ----------- | --------------- | ------ | ------ | --------- | 
| CALL REST API (PB) | This is a general-purpose function to call any REST API or other HTTP service. | Manual | artifact | `enabled` | `-` | 
