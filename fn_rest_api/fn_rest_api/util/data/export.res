{
  ...
  "fields": [
    ...
    },
    {
      ...
      "tags": [],
      "templates": [],
      "text": "send_file_as_body",
      "tooltip": "Send attachment as binary data in request body",
      "type_id": 11,
      "uuid": "cb679a81-c16e-4518-a551-3df59aa66f44",
      "values": []
    },
    {
      "allow_default_value": false,
  ...
  "functions": [
    {
      ...
      "last_modified_by": {
        "display_name": "svfvd",
        "id": 4,
        "name": "c983aca7-caff-4e4e-bd5a-002d943c9abc",
        "type": "apikey"
      },
      "last_modified_time": 1778509384430,
      "name": "rest_api",
      "output_description": {
        "content": null,
        "format": "text"
      ...
      "view_items": [
        ...
        {
          "content": "cb679a81-c16e-4518-a551-3df59aa66f44",
          "element": "field_uuid",
          "field_type": "__function",
          "show_if": null,
          "show_link_header": false,
  ...
  "message_destinations": [
    {
      "api_keys": [
        "c983aca7-caff-4e4e-bd5a-002d943c9abc"
      ],
      "destination_type": 0,
      "expect_ack": true,
  ...
  "playbooks": [
    {
      ...
      "last_modified_time": 1778509387935,
      "local_scripts": [
        {
          "actions": [],
          "created_date": 1778509386027,
          "description": "Script to process Endpoint response.",
          "enabled": false,
          "export_key": "Process REST Response",
          "id": 2,
          "language": "python3",
          "last_modified_by": "c983aca7-caff-4e4e-bd5a-002d943c9abc",
          "last_modified_time": 1778509386027,
      ...
      "playbook_change_log_info": {
        ...
        "change_log_items": [],
        "change_number": 1,
        "change_number_prefix": "dc9e07d4-a2c6-4189-b6d5-ed0bb3a6142a",
        "create_date": 1778509387156,
        "modified_principal": {
          "display_name": "svfvd",
          "id": 4,
          "name": "c983aca7-caff-4e4e-bd5a-002d943c9abc",
