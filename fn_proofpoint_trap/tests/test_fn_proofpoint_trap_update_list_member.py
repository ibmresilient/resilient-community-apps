...
class TestFnProofpointTrapUpdateListMember:
    ...
    @pytest.mark.parametrize("trap_list_id, trap_member_id, trap_member_description, trap_expiration, trap_duration, expected_results", [
        (123, 123, "text", 1518367008000, 123, {"value": "xyz"}),
        (123, 123, "text", 1518367008000, 123, {"value": "xyz"})
    ])
    def test_success(self, circuits_app, trap_list_id, trap_member_id, trap_member_description, trap_expiration, trap_duration, expected_results):
