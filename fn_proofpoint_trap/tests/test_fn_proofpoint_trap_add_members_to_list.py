...
class TestFnProofpointTrapAddMembersToList:
    ...
    @patch('fn_proofpoint_trap.components.fn_proofpoint_trap_add_members_to_list.PPTRClient', side_effect=mocked_pptr_client)
    ...
    def test_success(self, mock_post, circuits_app, trap_list_id, trap_member, trap_description, trap_expiration, trap_duration, expected_results):
