...
def call_fn_api_void_request_function(circuits, function_params, timeout=5):
...
class TestFnApiVoidRequest:
    ...
    mock_inputs_1 = {
        "api_void_artifact_type": "sample text",
        "api_void_artifact_value": "sample text",
        "api_void_request_type": "ThreatLog"
    }
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_fn_api_void_request_function(circuits_app, mock_inputs)
