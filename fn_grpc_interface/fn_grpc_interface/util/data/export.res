{
  ...
  "fields": [
    ...
    },
    {
      ...
      "templates": [],
      "text": "grpc_function",
      "tooltip": "This fields contains data from .proto file i.e package_name : rpc function name(grpc request function) ex: helloword : SayHello(HelloRequest). This value takes precendence over value set in app.config",
      "type_id": 11,
    ...
    },
    {
      ...
      "templates": [],
      "text": "grpc_channel",
      "tooltip": "this field contain the channel info of the GRPC Server Running ex:hostIP:Port. This value takes precendence over value set in app.config",
      "type_id": 11,
  ...
  "functions": [
    {
      "created_date": 1631038374765,
      "creator": {
        "display_name": "MacBook Pro Integration Server",
        "id": 6,
      ...
      "last_modified_time": 1631130692814,
      "name": "function_grpc",
      "tags": [
        {
          "tag_handle": "fn_grpc_interface",
  ...
  "message_destinations": [
    {
      "api_keys": [
        ...
        "2c1e948d-a12f-403c-a27c-a84b94a17ef4"
      ],
      "destination_type": 0,
      "expect_ack": true,
      "export_key": "fn_grpc",
  ...
  "workflows": [
    {
      ...
      "last_modified_time": 1631220462745,
      "name": "Example: GRPC Communication Interface",
      "object_type": "artifact",
      "programmatic_name": "example_grpc_communication_interface",
      "tags": [
