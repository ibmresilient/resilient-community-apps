...
### Description
Returns the contributing rules for the Offense
...
## Local script - Example of fetching contributing rules for Offense
...
### Script Content
```python
results = playbook.functions.results.rules_result
