...
class FunctionComponent(ResilientComponent):
    ...
    def _qradar_top_events(self, event, *args, **kwargs):
        ...
        try:
            ...
            LOG.info(f"qradar_search_param6: {qradar_search_param6}")
            LOG.info(f"qradar_search_time: {qradar_search_time}")
            ...
            LOG.info(f"Running query: {temp_query_string}")

            # Get the wf_instance_id of the workflow this Function was called in, if not found return a backup string
            wf_instance_id = event.message.get("workflow_instance", {}).get("workflow_instance_id", "no instance id found")
            yield StatusMessage(f"Starting 'qradar_top_events' that was running in workflow '{wf_instance_id}'")
            ...
            yield StatusMessage(f"Finished 'qradar_top_events' that was running in workflow '{wf_instance_id}'")
