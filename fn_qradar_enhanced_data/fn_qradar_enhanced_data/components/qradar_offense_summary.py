...
class FunctionComponent(ResilientComponent):
    ...
    def _qradar_offense_summary(self, event, *args, **kwargs):
        ...
        try:
            ...
            LOG.info(f"qradar_offenseid: {qradar_offenseid}")
            LOG.info(f"qradar_label: {qradar_label}")

            # Get the wf_instance_id of the workflow this Function was called in, if not found return a backup string
            wf_instance_id = event.message.get("workflow_instance", {}).get("workflow_instance_id", "no instance id found")
            yield StatusMessage(f"Starting 'qradar_offense_summary' that was running in workflow '{wf_instance_id}'")
            ...
            yield StatusMessage(f"Finished 'qradar_offense_summary' that was running in workflow '{wf_instance_id}'")
