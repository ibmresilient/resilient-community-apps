...
# Playbook - Sumo Logic: Write Insight JSON to Note
...
---
## Local script - Sumo Logic: Write Insight Results to Note

### Description
Format results from get insight by id to pass to JSON conversion script.
