...
# Playbook - Sumo Logic: Write Entity JSON to Note
...
### Description
Write the Sumo Logic entity information to a note.
...
## Local script - Sumo Logic: Write Entity to Note

### Description
Write the results of get entities function to a formatted note.
