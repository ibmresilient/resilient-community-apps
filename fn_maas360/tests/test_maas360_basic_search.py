...
class TestMaas360BasicSearch:
    ...
    @pytest.mark.parametrize("maas360_device_name, maas360_username, maas360_phone_no, maas360_imei_meid, maas360_platform_name, maas360_device_id, maas360_email, expected_results", [
        ("text", "text", "text", "text", 'Others', "text", "text", {"value": "xyz"}),
        ("text", "text", "text", "text", 'Windows', "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, maas360_device_name, maas360_username, maas360_phone_no, maas360_imei_meid, maas360_platform_name, maas360_device_id, maas360_email, expected_results):
        """ Test calling with sample values for the parameters """
        function_params = { 
            "maas360_device_name": maas360_device_name,
            "maas360_username": maas360_username,
            "maas360_phone_no": maas360_phone_no,
