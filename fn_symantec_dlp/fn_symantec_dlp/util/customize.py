...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [u"symantec_dlp_close_dlp_case", u"symantec_dlp_get_incident_details", u"symantec_dlp_get_notes", u"symantec_dlp_send_note_to_dlp_incident", u"symantec_dlp_update_incident_status", u"symantec_dlp_upload_binaries"],
        "workflows": [u"sdlp_close_dlp_case", u"sdlp_get_notes", u"sdlp_resolve_incident_in_dlp", u"sdlp_send_soar_note_to_dlp", u"sdlp_update_incident_status", u"sdlp_upload_binaries", u"sdlp_write_incident_details_to_note"],
        "actions": [u"Symantec DLP: Close DLP Case", u"Symantec DLP: Get DLP Notes", u"Symantec DLP: Resolve Incident in DLP", u"Symantec DLP: Send SOAR Note to DLP", u"Symantec DLP: Update DLP Incident Status", u"Symantec DLP: Upload Binaries", u"Symantec DLP: Upload Binaries as Artifact", u"Symantec DLP: Write DLP Incident Details to Note"],
