...
"""Generate the SOAR customizations required for fn_symantec_dlp"""
...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [
            u"symantec_dlp_close_dlp_case",
            u"symantec_dlp_get_incident_details",
            u"symantec_dlp_get_notes",
            u"symantec_dlp_send_note_to_dlp_incident",
            u"symantec_dlp_update_incident",
            u"symantec_dlp_upload_binaries"
        ],
        "workflows": [
            u"sdlp_close_dlp_case",
            u"sdlp_get_notes",
            u"sdlp_resolve_incident_in_dlp",
            u"sdlp_send_soar_note_to_dlp",
            u"sdlp_update_incident",
            u"sdlp_update_severity_in_dlp",
            u"sdlp_upload_binaries",
            u"sdlp_write_incident_details_to_note"
        ],
        "actions": [
            u"Symantec DLP: Close DLP Case",
            u"Symantec DLP: Get DLP Notes",
            u"Symantec DLP: Resolve Incident in DLP",
            u"Symantec DLP: Send SOAR Note to DLP",
            u"Symantec DLP: Update DLP Incident",
            u"Symantec DLP: Update Severity in DLP",
            u"Symantec DLP: Upload Binaries",
            u"Symantec DLP: Upload Binaries as Artifact",
            u"Symantec DLP: Write DLP Incident Details to Note"
        ],
        "incident_fields": [
            u"sdlp_incident_id",
            u"sdlp_incident_status",
            u"sdlp_incident_url",
            u"sdlp_policy_group_id",
            u"sdlp_policy_group_name",
            u"sdlp_policy_id",
            u"sdlp_policy_name"
        ],
        ...
        "automatic_tasks": [],
        "scripts": [
            u"Convert JSON to rich text v1.1"
        ],
        "playbooks": [
            u"symantec_dlp_upload_binaries_as_attachment__example_pb"
        ]
    }
