...
FN_NAME = "darktrace_get_model_breaches"


class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'darktrace_get_model_breaches'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Get model breaches from Darktrace using the Darkrace API
        """
