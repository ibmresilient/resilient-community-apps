...
FN_NAME = "harfanglab_telemetry_search_driver_by_filename"


class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'harfanglab_telemetry_search_driver_by_filename'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        validate_fields(["harfanglab_filename"], fn_inputs)
        ...
        try:
            ...
            results = conn.search_telemetry('searchDriverByFileName', args)
