...
FUNCTION_NAME = "harfanglab_telemetry_search_source_ip"
...
class TestHarfanglabTelemetrySearchSourceIp:
    """ Tests for the harfanglab_telemetry_search_source_ip function"""
