...
def call_harfanglab_telemetry_search_driver_by_filename_function(circuits, function_params, timeout=5):
    ...
    evt = SubmitTestFunction("harfanglab_telemetry_search_driver_by_filename", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("harfanglab_telemetry_search_driver_by_filename_result", parent=evt, timeout=timeout)
        assert event
...
class TestHarfanglabTelemetrySearchDriverByFilename:
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_harfanglab_telemetry_search_driver_by_filename_function(circuits_app, mock_inputs)
