...
def call_netwitness_get_meta_values_function(circuits, function_params, timeout=10):
    ...
    evt = SubmitTestFunction("netwitness_get_meta_values", function_params)
    circuits.manager.fire(evt)
    event = circuits.watcher.wait("netwitness_get_meta_values_result", parent=evt, timeout=timeout)
    assert event
...
class TestNetwitnessGetMetaValues:
    """ Tests for the netwitness_get_meta_values function"""
