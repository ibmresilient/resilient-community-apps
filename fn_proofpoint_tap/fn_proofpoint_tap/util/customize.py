...
"""Generate the SOAR customizations required for fn_proofpoint_tap"""
...
def codegen_reload_data():
    ...
    return {
        ...
        "incident_artifact_types": [
            u"proofpoint_campaign_id",
            u"proofpoint_threat_id"
        ],
        "incident_types": [],
        "datatables": [
            u"proofpoint_tap_campaign_object_dt"
        ],
        "automatic_tasks": [],
        "scripts": [
            u"Example: Proofpoint TAP - Create Artifact for Campaign Object Name or Threat"
        ],
        "playbooks": [
            u"example_proofpoint_tap__aggregate_forensics_by_campaign_id_pb",
            ...
            u"example_proofpoint_tap__create_artifact_for_campaign_object_name_or_threat_pb",
            u"example_proofpoint_tap__get_campaign_information_by_campaign_id_pb"
        ]
    }
