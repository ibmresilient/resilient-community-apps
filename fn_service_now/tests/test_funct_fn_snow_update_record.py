...
def call_fn_snow_update_record_function(circuits, function_params, timeout=5):
...
class TestFnSnowUpdateRecord:
    ...
    def test_success(self, circuits_app, mock_inputs, expected_results):
        ...
        results = call_fn_snow_update_record_function(circuits_app, mock_inputs)
