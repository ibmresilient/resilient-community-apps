...
/// Condition ///
/////////////////
!current.isValidField("x_ibmrt_resilient_ibm_resilient_reference_id") && current.getValue("x_ibmrt_resilient_ibm_soar_reference_id") != null && gs.getProperty("x_ibmrt_resilient.ServiceNowUsername") != gs.getUserName()
