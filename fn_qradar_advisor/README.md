...
| Version | Date | Notes |
| ------- | ---- | ----- |
| 2.1.1 | 7/2024 | Converted workflows to Python3 |
...
| Watson Search | artifact | `qradar_advisor_quick_search` | `artifact.type equals DNS Name OR artifact.type equals IP Address OR artifact.type equals Malware MD5 Hash OR artifact.type equals Malware SHA-1 Hash OR artifact.type equals Malware SHA-256 Hash OR artifact.type equals URL` |
| Watson Search with Local Context | artifact | `qradar_advisor_full_search` | `artifact.type equals DNS Name OR artifact.type equals IP Address OR artifact.type equals Malware MD5 Hash OR artifact.type equals Malware SHA-1 Hash OR artifact.type equals Malware SHA-256 Hash OR artifact.type equals URL OR artifact.type equals User Account` |
