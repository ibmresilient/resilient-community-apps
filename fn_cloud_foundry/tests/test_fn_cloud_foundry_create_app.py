...
class TestFnCloudFoundryCreateApp:
    ...
    @pytest.mark.parametrize("fn_cloud_foundry_applications, fn_cloud_foundry_space_guid, fn_cloud_foundry_additional_parameters_json, expected_results", [
        ("text", "text", "text", {"value": "xyz"}),
        ("text", "text", "text", {"value": "xyz"})
    ])
    def test_success(self, circuits_app, fn_cloud_foundry_applications, fn_cloud_foundry_space_guid, fn_cloud_foundry_additional_parameters_json, expected_results):
