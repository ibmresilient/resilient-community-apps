...
| ----------------- | -------- | ------------ | ------- | ----------- |
| Boolean Field | `dt_boolean_field` | boolean | - | Optional |
| Datetime Field | `dt_datetime_field` | datetimepicker | - | Optional |
| Multi_Select Field | `dt_multi_select_field` | multiselect | - | Optional |
| Name Field | `dt_name_field` | text | - | Optional |
| Number Field | `dt_number_field` | number | - | Optional |
| Select Field | `dt_select_field` | select | - | Optional |
| Text Field | `dt_text_field` | text | - | Optional |
