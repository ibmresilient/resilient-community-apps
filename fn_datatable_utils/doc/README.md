...
Add CVS data to a named datatable.
...
| `dt_mapping_table` | `text` | No | `Mapping Table` | String formatted json: """{ "cve": "cve_id", "pubdte": "published_date", "sum": "summary"}""" |
...
## Data Table - Example CSV Datatable
 ...
 ![screenshot: dt-example-csv-datatable](./screenshots/dt-0.png)
