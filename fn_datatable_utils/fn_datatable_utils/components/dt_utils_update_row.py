...
class FunctionComponent(ResilientComponent):
    ...
    def _dt_utils_update_row_function(self, event, *args, **kwargs):
        ...
        try:
            ...
            # Update the row
            res = datatable.update_row(payload.inputs["dt_utils_row_id"], payload.inputs["dt_utils_cells_to_update"])
            ...
            if res:
                ...
                log.info("Did not update the row with id: {0}".format(payload.inputs["dt_utils_row_id"]))
