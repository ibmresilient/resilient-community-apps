...
def call_azure_get_automation_job_output_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("azure_get_automation_job_output", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("azure_get_automation_job_output_result", parent=evt, timeout=timeout)
        assert event
...
class TestAzureGetAutomationJobOutput:
    """ Tests for the azure_get_automation_job_output function"""
