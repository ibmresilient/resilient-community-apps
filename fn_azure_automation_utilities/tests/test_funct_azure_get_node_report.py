...
FUNCTION_NAME = "azure_get_node_report"
...
def call_azure_get_node_report_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("azure_get_node_report", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("azure_get_node_report_result", parent=evt, timeout=timeout)
        assert event
...
class TestAzureGetNodeReport:
    """ Tests for the azure_get_node_report function"""
    ...
    expected_results_1 = helper.get_node_report_results()
