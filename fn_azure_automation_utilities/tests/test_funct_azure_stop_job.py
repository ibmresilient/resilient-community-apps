...
def call_azure_stop_job_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("azure_stop_job", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("azure_stop_job_result", parent=evt, timeout=timeout)
        assert event
...
class TestAzureStopJob:
    """ Tests for the azure_stop_job function"""
