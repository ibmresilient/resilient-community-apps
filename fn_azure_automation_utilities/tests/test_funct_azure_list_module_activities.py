...
FUNCTION_NAME = "azure_list_module_activities"
...
def call_azure_list_module_activities_function(circuits, function_params, timeout=5):
    # Create the submitTestFunction event
    evt = SubmitTestFunction("azure_list_module_activities", function_params)
    ...
    # else return the FunctionComponent's results
        ...
        event = circuits.watcher.wait("azure_list_module_activities_result", parent=evt, timeout=timeout)
        assert event
...
class TestAzureListAutomationModuleActivities:
    ...
    expected_results_1 = helper.list_module_activities_results()
