...
FN_NAME = "azure_get_agent_registration_information"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_get_agent_registration_information'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.get_agent_registration_information()
