...
FN_NAME = "azure_list_node_report_by_node"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_list_node_report_by_node'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Retrieve the Dsc node report list by node id.
        Inputs:
        ...
        results = client.list_node_report_by_node(getattr(fn_inputs, "node_id"))
