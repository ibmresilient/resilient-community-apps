...
FN_NAME = "azure_list_statistics_by_automation_account"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_list_statistics_by_automation_account'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Retrieve the statistics for the account.
        Inputs:
