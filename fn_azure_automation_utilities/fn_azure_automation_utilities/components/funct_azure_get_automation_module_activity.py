...
FN_NAME = "azure_get_automation_module_activity"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_get_automation_module_activity'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.get_automation_module_activity(
