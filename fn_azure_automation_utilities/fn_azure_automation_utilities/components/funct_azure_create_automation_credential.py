...
FN_NAME = "azure_create_automation_credential"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_create_automation_credential'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.create_automation_credential(getattr(fn_inputs, "credential_name"), input_parameters)
