...
FN_NAME = "azure_list_runbooks_by_automation_account"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_list_runbooks_by_automation_account'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Retrieve a list of runbooks on the given automation account.
        Inputs:
