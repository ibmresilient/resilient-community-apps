...
FN_NAME = "azure_create_automation_schedule"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_create_automation_schedule'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.create_automation_schedule(getattr(fn_inputs, "schedule_name"), input_parameters)
