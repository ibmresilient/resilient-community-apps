...
FN_NAME = "azure_update_schedule"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_update_schedule'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.update_schedule(getattr(fn_inputs, "schedule_name"), input_parameters)
