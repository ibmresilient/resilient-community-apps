...
FN_NAME = "azure_get_automation_job_output"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_get_automation_job_output'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Retrieve the job output identified by job name
        Inputs:
        ...
        # Make call to Azure to get job results
