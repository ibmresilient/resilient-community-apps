...
FN_NAME = "azure_list_accounts_by_resource_group"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_list_accounts_by_resource_group'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.list_accounts_by_resource_group()
