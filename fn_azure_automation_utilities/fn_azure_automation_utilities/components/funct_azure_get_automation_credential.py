...
FN_NAME = "azure_get_automation_credential"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_get_automation_credential'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.get_automation_credential(getattr(fn_inputs, "credential_name"))
