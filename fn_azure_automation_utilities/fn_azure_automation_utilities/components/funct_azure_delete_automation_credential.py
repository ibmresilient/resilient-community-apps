...
FN_NAME = "azure_delete_automation_credential"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_delete_automation_credential'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Delete the credential.
        Inputs:
        ...
        response = client.delete_automation_credential(getattr(fn_inputs, "credential_name"))
