...
FN_NAME = "azure_list_automation_module_activities"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_list_automation_module_activities'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.list_automation_module_activities(getattr(fn_inputs, "module_name"))
