...
FN_NAME = "azure_list_automation_credentials_by_automation_account"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_list_automation_credentials_by_automation_account'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: Retrieve a list of credentials
        Inputs:
        ...
        results = client.list_automation_credentials_by_automation_account()
