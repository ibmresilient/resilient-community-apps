...
FN_NAME = "azure_update_automation_credential"

class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'azure_update_automation_credential'"""
    ...
    def _app_function(self, fn_inputs):
        ...
        results = client.update_automation_credential(getattr(fn_inputs, "credential_name"), input_parameters)
