<!--
  ...
  This file was generated with resilient-sdk v48.0.3934
...
-->
**IBM SOAR app bidirectional synchronization and functions for Trusteer Poinpoint Detect**
...
| ------ | :------: | ------- | ----------- |
| **api_token** | Yes | `xxx` | *Enter a description of the config here.* <!-- ::CHANGE_ME:: --> |
| **api_version** | Yes | `v1` | *Enter a description of the config here.* <!-- ::CHANGE_ME:: --> |
| **endpoint_url** | Yes | `https://trusteer.com` | *Enter a description of the config here.* <!-- ::CHANGE_ME:: --> |
| **verify** | Yes | `true` | *Enter a description of the config here.* <!-- ::CHANGE_ME:: --> |
| **verify** | Yes | `True` | *Boolean indicating whether to verify the Trusteer client certificate.* |
### Custom Layouts
<!--
...
results = {
  "content": {
    "link_url_device_id": "https://fake.trusteer.com/search-results?device_id=111-222-333-444\u0026type=session",
    "link_url_puid": "https://fake.trusteer.com/search-results?puid=aaa-bbb-ccc-ddd\u0026type=session"
  },
  "inputs": {
    "trusteer_ppd_device_id": "111-222-333-444",
    "trusteer_ppd_puid": "aaa-bbb-ccc-ddd"
  },
  "metrics": {
    "execution_time_ms": 7306,
    "host": "laptop",
    "package": "fn-trusteer-ppd",
    "package_version": "1.0.0",
    "timestamp": "2023-02-06 17:07:38",
    "version": "1.0"
  },
  "raw": null,
  "reason": null,
...
results = {
    ...
    #   3. Gather the results using: $ resilient-sdk codegen -p fn_trusteer_ppd --gather-results
    #   4. Run docgen again: $ resilient-sdk docgen -p fn_trusteer_ppd
} 
```
...
| Device ID | `trusteer_ppd_dt_device_id` | `text` | - |
| Device Link | `trusteer_ppd_dt_device_link` | `textarea` | - |
