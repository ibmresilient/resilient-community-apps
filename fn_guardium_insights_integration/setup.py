...
setup(
    ...
    entry_points={
        "resilient.circuits.components": [
            ...
            "{}FunctionComponent = fn_guardium_insights_integration.components.{}:FunctionComponent".format(
                snake_to_camel(get_module_name(filename)), get_module_name(filename)) for filename in
            glob.glob("./fn_guardium_insights_integration/components/[a-zA-Z]*.py")
        ],
        "resilient.circuits.configsection": [
            "gen_config = fn_guardium_insights_integration.util.config:config_section_data"],
        "resilient.circuits.customize": [
            "customize = fn_guardium_insights_integration.util.customize:customization_data"],
