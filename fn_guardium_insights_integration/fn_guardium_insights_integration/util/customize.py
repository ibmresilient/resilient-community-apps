...
"""Generate the SOAR customizations required for fn_guardium_insights_integration"""
...
def codegen_reload_data():
    ...
    return {
        ...
        "message_destinations": [
            u"guardium_insights_integration"
        ],
        "functions": [
            u"function_guardium_insights_block_user",
            u"function_guardium_insights_classification_report",
            u"function_guardium_insights_populate_breach_data_types"
        ],
        "workflows": [
            u"workflow_guardium_insights_block_user",
            u"workflow_guardium_insights_classification_report",
            u"workflow_guardium_insights_populate_breach_data_types"
        ],
        "actions": [
            u"Guardium Insights Block User",
            u"Guardium Insights classification report data",
            u"Guardium Insights populate breach data types"
        ],
        "incident_fields": [
            u"field_guardium_insights_config_id",
            u"field_guardium_insights_global_id",
            u"field_guardium_insights_what",
            u"field_guardium_insights_when",
            u"field_guardium_insights_where",
            u"field_guardium_insights_who",
            u"field_guardium_insights_why",
            u"guardium_insights_event_id"
        ],
        "incident_artifact_types": [],
        "incident_types": [],
        "datatables": [
            u"guardium_insights_classification_report"
        ],
        "automatic_tasks": [],
        "scripts": [],
        "playbooks": [],
