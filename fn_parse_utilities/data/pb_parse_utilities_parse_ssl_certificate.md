...
# Playbook - Parse Utilities: Parse SSL Certificate - Example (PB)
...
`artifact.type equals X509 Certificate File`
...
---
## Local script - Process SSL Results

### Description
Add a note with certificate details
