...
# Playbook - Parse Utilities: Email Parsing (Artifact) - Example (PB) 
...
`artifact.type in ['RFC 822 Email Message File', 'Email Attachment', 'Other File']`
...
inputs.parse_utilities_email_attachments = False
```

---

## Local script - Email Parsing (Artifact)
